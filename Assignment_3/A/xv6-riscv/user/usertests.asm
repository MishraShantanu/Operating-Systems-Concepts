...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	d4250513          	addi	a0,a0,-702 # 5d80 <malloc+0xec>
      46:	00006097          	auipc	ra,0x6
      4a:	b96080e7          	jalr	-1130(ra) # 5bdc <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	d2050513          	addi	a0,a0,-736 # 5da0 <malloc+0x10c>
      88:	00006097          	auipc	ra,0x6
      8c:	b54080e7          	jalr	-1196(ra) # 5bdc <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d1050513          	addi	a0,a0,-752 # 5db8 <malloc+0x124>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d1250513          	addi	a0,a0,-750 # 5dd8 <malloc+0x144>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	cda50513          	addi	a0,a0,-806 # 5dc0 <malloc+0x12c>
      ee:	00006097          	auipc	ra,0x6
      f2:	aee080e7          	jalr	-1298(ra) # 5bdc <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	ce650513          	addi	a0,a0,-794 # 5de8 <malloc+0x154>
     10a:	00006097          	auipc	ra,0x6
     10e:	ad2080e7          	jalr	-1326(ra) # 5bdc <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	ce450513          	addi	a0,a0,-796 # 5e10 <malloc+0x17c>
     134:	00005097          	auipc	ra,0x5
     138:	75e080e7          	jalr	1886(ra) # 5892 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	cd050513          	addi	a0,a0,-816 # 5e10 <malloc+0x17c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	ccc58593          	addi	a1,a1,-820 # 5e20 <malloc+0x18c>
     15c:	00005097          	auipc	ra,0x5
     160:	706080e7          	jalr	1798(ra) # 5862 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	ca850513          	addi	a0,a0,-856 # 5e10 <malloc+0x17c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	cac58593          	addi	a1,a1,-852 # 5e28 <malloc+0x194>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	c7c50513          	addi	a0,a0,-900 # 5e10 <malloc+0x17c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	c6650513          	addi	a0,a0,-922 # 5e30 <malloc+0x19c>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a0a080e7          	jalr	-1526(ra) # 5bdc <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	bdc50513          	addi	a0,a0,-1060 # 5e58 <malloc+0x1c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	bc8a8a93          	addi	s5,s5,-1080 # 5e58 <malloc+0x1c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	b5650513          	addi	a0,a0,-1194 # 5e68 <malloc+0x1d4>
     31a:	00006097          	auipc	ra,0x6
     31e:	8c2080e7          	jalr	-1854(ra) # 5bdc <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	b5450513          	addi	a0,a0,-1196 # 5e88 <malloc+0x1f4>
     33c:	00006097          	auipc	ra,0x6
     340:	8a0080e7          	jalr	-1888(ra) # 5bdc <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	b30a0a13          	addi	s4,s4,-1232 # 5ea0 <malloc+0x20c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	a8c50513          	addi	a0,a0,-1396 # 5ea8 <malloc+0x214>
     424:	00005097          	auipc	ra,0x5
     428:	7b8080e7          	jalr	1976(ra) # 5bdc <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	a8650513          	addi	a0,a0,-1402 # 5ec0 <malloc+0x22c>
     442:	00005097          	auipc	ra,0x5
     446:	79a080e7          	jalr	1946(ra) # 5bdc <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	a9850513          	addi	a0,a0,-1384 # 5ef0 <malloc+0x25c>
     460:	00005097          	auipc	ra,0x5
     464:	77c080e7          	jalr	1916(ra) # 5bdc <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	aae50513          	addi	a0,a0,-1362 # 5f20 <malloc+0x28c>
     47a:	00005097          	auipc	ra,0x5
     47e:	762080e7          	jalr	1890(ra) # 5bdc <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	aa050513          	addi	a0,a0,-1376 # 5f30 <malloc+0x29c>
     498:	00005097          	auipc	ra,0x5
     49c:	744080e7          	jalr	1860(ra) # 5bdc <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	a92a0a13          	addi	s4,s4,-1390 # 5f60 <malloc+0x2cc>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	952a8a93          	addi	s5,s5,-1710 # 5e28 <malloc+0x194>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	9ec50513          	addi	a0,a0,-1556 # 5f68 <malloc+0x2d4>
     584:	00005097          	auipc	ra,0x5
     588:	658080e7          	jalr	1624(ra) # 5bdc <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	9e650513          	addi	a0,a0,-1562 # 5f80 <malloc+0x2ec>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	63a080e7          	jalr	1594(ra) # 5bdc <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	96c50513          	addi	a0,a0,-1684 # 5f20 <malloc+0x28c>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	620080e7          	jalr	1568(ra) # 5bdc <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	9e250513          	addi	a0,a0,-1566 # 5fb0 <malloc+0x31c>
     5d6:	00005097          	auipc	ra,0x5
     5da:	606080e7          	jalr	1542(ra) # 5bdc <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	9dc50513          	addi	a0,a0,-1572 # 5fc8 <malloc+0x334>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	5e8080e7          	jalr	1512(ra) # 5bdc <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	7de58593          	addi	a1,a1,2014 # 5e20 <malloc+0x18c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	7b250513          	addi	a0,a0,1970 # 5e10 <malloc+0x17c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	78650513          	addi	a0,a0,1926 # 5e10 <malloc+0x17c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	77250513          	addi	a0,a0,1906 # 5e10 <malloc+0x17c>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	97c58593          	addi	a1,a1,-1668 # 6058 <malloc+0x3c4>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	6f250513          	addi	a0,a0,1778 # 5e10 <malloc+0x17c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	89650513          	addi	a0,a0,-1898 # 5ff8 <malloc+0x364>
     76a:	00005097          	auipc	ra,0x5
     76e:	472080e7          	jalr	1138(ra) # 5bdc <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	89a50513          	addi	a0,a0,-1894 # 6018 <malloc+0x384>
     786:	00005097          	auipc	ra,0x5
     78a:	456080e7          	jalr	1110(ra) # 5bdc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	89650513          	addi	a0,a0,-1898 # 6028 <malloc+0x394>
     79a:	00005097          	auipc	ra,0x5
     79e:	442080e7          	jalr	1090(ra) # 5bdc <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	89a50513          	addi	a0,a0,-1894 # 6048 <malloc+0x3b4>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	426080e7          	jalr	1062(ra) # 5bdc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	86650513          	addi	a0,a0,-1946 # 6028 <malloc+0x394>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	412080e7          	jalr	1042(ra) # 5bdc <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	88050513          	addi	a0,a0,-1920 # 6060 <malloc+0x3cc>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	3f4080e7          	jalr	1012(ra) # 5bdc <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	88250513          	addi	a0,a0,-1918 # 6080 <malloc+0x3ec>
     806:	00005097          	auipc	ra,0x5
     80a:	3d6080e7          	jalr	982(ra) # 5bdc <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	86e50513          	addi	a0,a0,-1938 # 60a0 <malloc+0x40c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	87e98993          	addi	s3,s3,-1922 # 60c8 <malloc+0x434>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	8aea8a93          	addi	s5,s5,-1874 # 6100 <malloc+0x46c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	80850513          	addi	a0,a0,-2040 # 60a0 <malloc+0x40c>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	7cc50513          	addi	a0,a0,1996 # 60a0 <malloc+0x40c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	7aa50513          	addi	a0,a0,1962 # 60a8 <malloc+0x414>
     906:	00005097          	auipc	ra,0x5
     90a:	2d6080e7          	jalr	726(ra) # 5bdc <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	7bc50513          	addi	a0,a0,1980 # 60d8 <malloc+0x444>
     924:	00005097          	auipc	ra,0x5
     928:	2b8080e7          	jalr	696(ra) # 5bdc <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	7d650513          	addi	a0,a0,2006 # 6110 <malloc+0x47c>
     942:	00005097          	auipc	ra,0x5
     946:	29a080e7          	jalr	666(ra) # 5bdc <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	7e250513          	addi	a0,a0,2018 # 6138 <malloc+0x4a4>
     95e:	00005097          	auipc	ra,0x5
     962:	27e080e7          	jalr	638(ra) # 5bdc <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	7e650513          	addi	a0,a0,2022 # 6158 <malloc+0x4c4>
     97a:	00005097          	auipc	ra,0x5
     97e:	262080e7          	jalr	610(ra) # 5bdc <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	7e250513          	addi	a0,a0,2018 # 6170 <malloc+0x4dc>
     996:	00005097          	auipc	ra,0x5
     99a:	246080e7          	jalr	582(ra) # 5bdc <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	7d050513          	addi	a0,a0,2000 # 6190 <malloc+0x4fc>
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	77e50513          	addi	a0,a0,1918 # 6190 <malloc+0x4fc>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	73e50513          	addi	a0,a0,1854 # 6198 <malloc+0x504>
     a62:	00005097          	auipc	ra,0x5
     a66:	17a080e7          	jalr	378(ra) # 5bdc <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	74050513          	addi	a0,a0,1856 # 61b8 <malloc+0x524>
     a80:	00005097          	auipc	ra,0x5
     a84:	15c080e7          	jalr	348(ra) # 5bdc <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	74c50513          	addi	a0,a0,1868 # 61e0 <malloc+0x54c>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	140080e7          	jalr	320(ra) # 5bdc <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	6d050513          	addi	a0,a0,1744 # 6190 <malloc+0x4fc>
     ...
     af0:	71450513          	addi	a0,a0,1812 # 6200 <malloc+0x56c>
     af4:	00005097          	auipc	ra,0x5
     af8:	0e8080e7          	jalr	232(ra) # 5bdc <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	71e50513          	addi	a0,a0,1822 # 6228 <malloc+0x594>
     b12:	00005097          	auipc	ra,0x5
     b16:	0ca080e7          	jalr	202(ra) # 5bdc <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	71850513          	addi	a0,a0,1816 # 6240 <malloc+0x5ac>
     b30:	00005097          	auipc	ra,0x5
     b34:	0ac080e7          	jalr	172(ra) # 5bdc <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	72450513          	addi	a0,a0,1828 # 6268 <malloc+0x5d4>
     b4c:	00005097          	auipc	ra,0x5
     b50:	090080e7          	jalr	144(ra) # 5bdc <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	70e50513          	addi	a0,a0,1806 # 6280 <malloc+0x5ec>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	72658593          	addi	a1,a1,1830 # 62b0 <malloc+0x61c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	6da50513          	addi	a0,a0,1754 # 6280 <malloc+0x5ec>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	6c450513          	addi	a0,a0,1732 # 6280 <malloc+0x5ec>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	6ae50513          	addi	a0,a0,1710 # 6280 <malloc+0x5ec>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	71258593          	addi	a1,a1,1810 # 62f8 <malloc+0x664>
  ...
  unlink("unlinkread");
     ...
     c52:	63250513          	addi	a0,a0,1586 # 6280 <malloc+0x5ec>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	62250513          	addi	a0,a0,1570 # 6290 <malloc+0x5fc>
     c76:	00005097          	auipc	ra,0x5
     c7a:	f66080e7          	jalr	-154(ra) # 5bdc <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	62e50513          	addi	a0,a0,1582 # 62b8 <malloc+0x624>
     c92:	00005097          	auipc	ra,0x5
     c96:	f4a080e7          	jalr	-182(ra) # 5bdc <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	63250513          	addi	a0,a0,1586 # 62d8 <malloc+0x644>
     cae:	00005097          	auipc	ra,0x5
     cb2:	f2e080e7          	jalr	-210(ra) # 5bdc <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	63e50513          	addi	a0,a0,1598 # 6300 <malloc+0x66c>
     cca:	00005097          	auipc	ra,0x5
     cce:	f12080e7          	jalr	-238(ra) # 5bdc <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	64250513          	addi	a0,a0,1602 # 6320 <malloc+0x68c>
     ce6:	00005097          	auipc	ra,0x5
     cea:	ef6080e7          	jalr	-266(ra) # 5bdc <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	64650513          	addi	a0,a0,1606 # 6340 <malloc+0x6ac>
     d02:	00005097          	auipc	ra,0x5
     d06:	eda080e7          	jalr	-294(ra) # 5bdc <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	55258593          	addi	a1,a1,1362 # 62b0 <malloc+0x61c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	5ea58593          	addi	a1,a1,1514 # 6368 <malloc+0x6d4>
     d86:	00005517          	auipc	a0,0x5
     d8a:	5da50513          	addi	a0,a0,1498 # 6360 <malloc+0x6cc>
  ...
  unlink("lf1");
     ...
     d9e:	5c650513          	addi	a0,a0,1478 # 6360 <malloc+0x6cc>
     da2:	00005097          	auipc	ra,0x5
     da6:	af0080e7          	jalr	-1296(ra) # 5892 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	5b450513          	addi	a0,a0,1460 # 6360 <malloc+0x6cc>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	5a650513          	addi	a0,a0,1446 # 6368 <malloc+0x6d4>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	56e58593          	addi	a1,a1,1390 # 6368 <malloc+0x6d4>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	55850513          	addi	a0,a0,1368 # 6368 <malloc+0x6d4>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a7a080e7          	jalr	-1414(ra) # 5892 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	54058593          	addi	a1,a1,1344 # 6360 <malloc+0x6cc>
     e28:	00005517          	auipc	a0,0x5
     e2c:	54050513          	addi	a0,a0,1344 # 6368 <malloc+0x6d4>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	52458593          	addi	a1,a1,1316 # 6360 <malloc+0x6cc>
     e44:	00005517          	auipc	a0,0x5
     e48:	62c50513          	addi	a0,a0,1580 # 6470 <malloc+0x7dc>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	50a50513          	addi	a0,a0,1290 # 6370 <malloc+0x6dc>
     e6e:	00005097          	auipc	ra,0x5
     e72:	d6e080e7          	jalr	-658(ra) # 5bdc <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	50650513          	addi	a0,a0,1286 # 6388 <malloc+0x6f4>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	d52080e7          	jalr	-686(ra) # 5bdc <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	50250513          	addi	a0,a0,1282 # 63a0 <malloc+0x70c>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	d36080e7          	jalr	-714(ra) # 5bdc <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	50650513          	addi	a0,a0,1286 # 63c0 <malloc+0x72c>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	d1a080e7          	jalr	-742(ra) # 5bdc <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	51a50513          	addi	a0,a0,1306 # 63f0 <malloc+0x75c>
     ede:	00005097          	auipc	ra,0x5
     ee2:	cfe080e7          	jalr	-770(ra) # 5bdc <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	51650513          	addi	a0,a0,1302 # 6408 <malloc+0x774>
     efa:	00005097          	auipc	ra,0x5
     efe:	ce2080e7          	jalr	-798(ra) # 5bdc <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	51250513          	addi	a0,a0,1298 # 6420 <malloc+0x78c>
     f16:	00005097          	auipc	ra,0x5
     f1a:	cc6080e7          	jalr	-826(ra) # 5bdc <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	51e50513          	addi	a0,a0,1310 # 6448 <malloc+0x7b4>
     f32:	00005097          	auipc	ra,0x5
     f36:	caa080e7          	jalr	-854(ra) # 5bdc <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	53250513          	addi	a0,a0,1330 # 6478 <malloc+0x7e4>
     f4e:	00005097          	auipc	ra,0x5
     f52:	c8e080e7          	jalr	-882(ra) # 5bdc <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	4eca0a13          	addi	s4,s4,1260 # 6498 <malloc+0x804>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	49a50513          	addi	a0,a0,1178 # 6498 <malloc+0x804>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	43250513          	addi	a0,a0,1074 # 64a0 <malloc+0x80c>
    1076:	00005097          	auipc	ra,0x5
    107a:	b66080e7          	jalr	-1178(ra) # 5bdc <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	43250513          	addi	a0,a0,1074 # 64c0 <malloc+0x82c>
    1096:	00005097          	auipc	ra,0x5
    109a:	b46080e7          	jalr	-1210(ra) # 5bdc <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	43650513          	addi	a0,a0,1078 # 64e0 <malloc+0x84c>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	b2a080e7          	jalr	-1238(ra) # 5bdc <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	42498993          	addi	s3,s3,1060 # 6500 <malloc+0x86c>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	3f850513          	addi	a0,a0,1016 # 6510 <malloc+0x87c>
    1120:	00005097          	auipc	ra,0x5
    1124:	abc080e7          	jalr	-1348(ra) # 5bdc <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    1188:	c3498993          	addi	s3,s3,-972 # 5db8 <malloc+0x124>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	4fa78793          	addi	a5,a5,1274 # 7708 <malloc+0x1a74>
  ...
  if(pid == 0){
    ...
    126e:	ede78793          	addi	a5,a5,-290 # 8148 <malloc+0x24b4>
    ...
    1292:	b2a50513          	addi	a0,a0,-1238 # 5db8 <malloc+0x124>
    ...
    12aa:	31250513          	addi	a0,a0,786 # 65b8 <malloc+0x924>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	92e080e7          	jalr	-1746(ra) # 5bdc <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	26a50513          	addi	a0,a0,618 # 6530 <malloc+0x89c>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	90e080e7          	jalr	-1778(ra) # 5bdc <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	26a50513          	addi	a0,a0,618 # 6550 <malloc+0x8bc>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	8ee080e7          	jalr	-1810(ra) # 5bdc <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	26850513          	addi	a0,a0,616 # 6570 <malloc+0x8dc>
    1310:	00005097          	auipc	ra,0x5
    1314:	8cc080e7          	jalr	-1844(ra) # 5bdc <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	27050513          	addi	a0,a0,624 # 6598 <malloc+0x904>
    1330:	00005097          	auipc	ra,0x5
    1334:	8ac080e7          	jalr	-1876(ra) # 5bdc <printf>
    exit(1);
    1338:	4505                	li	a0,1
    ...
    1346:	6ee50513          	addi	a0,a0,1774 # 6a30 <malloc+0xd9c>
    134a:	00005097          	auipc	ra,0x5
    134e:	892080e7          	jalr	-1902(ra) # 5bdc <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	25450513          	addi	a0,a0,596 # 65e0 <malloc+0x94c>
    1394:	00005097          	auipc	ra,0x5
    1398:	848080e7          	jalr	-1976(ra) # 5bdc <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	a5250513          	addi	a0,a0,-1454 # 5e10 <malloc+0x17c>
  ...
  if(pid == 0){
    ...
    13ec:	a28a0a13          	addi	s4,s4,-1496 # 5e10 <malloc+0x17c>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	250a8a93          	addi	s5,s5,592 # 6640 <malloc+0x9ac>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	1b050513          	addi	a0,a0,432 # 6610 <malloc+0x97c>
    1468:	00004097          	auipc	ra,0x4
    146c:	774080e7          	jalr	1908(ra) # 5bdc <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	1ac50513          	addi	a0,a0,428 # 6628 <malloc+0x994>
    1484:	00004097          	auipc	ra,0x4
    1488:	758080e7          	jalr	1880(ra) # 5bdc <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	1b650513          	addi	a0,a0,438 # 6650 <malloc+0x9bc>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	73a080e7          	jalr	1850(ra) # 5bdc <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	958a0a13          	addi	s4,s4,-1704 # 5e10 <malloc+0x17c>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	1b0a8a93          	addi	s5,s5,432 # 6670 <malloc+0x9dc>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	90650513          	addi	a0,a0,-1786 # 5e10 <malloc+0x17c>
  ...
  exit(xstatus);
    ...
    152c:	10050513          	addi	a0,a0,256 # 6628 <malloc+0x994>
    1530:	00004097          	auipc	ra,0x4
    1534:	6ac080e7          	jalr	1708(ra) # 5bdc <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	13250513          	addi	a0,a0,306 # 6678 <malloc+0x9e4>
    154e:	00004097          	auipc	ra,0x4
    1552:	68e080e7          	jalr	1678(ra) # 5bdc <printf>
      exit(1);
    1556:	4505                	li	a0,1
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	84a78793          	addi	a5,a5,-1974 # 5db8 <malloc+0x124>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	11e78793          	addi	a5,a5,286 # 6698 <malloc+0xa04>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	11650513          	addi	a0,a0,278 # 66a0 <malloc+0xa0c>
  ...
  if(pid == 0) {
    ...
    15bc:	0e850513          	addi	a0,a0,232 # 66a0 <malloc+0xa0c>
    ...
    15d8:	0ec50513          	addi	a0,a0,236 # 66c0 <malloc+0xa2c>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	600080e7          	jalr	1536(ra) # 5bdc <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	02050513          	addi	a0,a0,32 # 6610 <malloc+0x97c>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	5e4080e7          	jalr	1508(ra) # 5bdc <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	09c50513          	addi	a0,a0,156 # 66a8 <malloc+0xa14>
    1614:	00004097          	auipc	ra,0x4
    1618:	5c8080e7          	jalr	1480(ra) # 5bdc <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	78e50513          	addi	a0,a0,1934 # 5db8 <malloc+0x124>
  ...
  if(xstatus != 0)
    ...
    1662:	07250513          	addi	a0,a0,114 # 66d0 <malloc+0xa3c>
    1666:	00004097          	auipc	ra,0x4
    166a:	576080e7          	jalr	1398(ra) # 5bdc <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	06e50513          	addi	a0,a0,110 # 66e8 <malloc+0xa54>
    1682:	00004097          	auipc	ra,0x4
    1686:	55a080e7          	jalr	1370(ra) # 5bdc <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	01250513          	addi	a0,a0,18 # 66a0 <malloc+0xa0c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	aa050513          	addi	a0,a0,-1376 # 6158 <malloc+0x4c4>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	51c080e7          	jalr	1308(ra) # 5bdc <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	f5450513          	addi	a0,a0,-172 # 6628 <malloc+0x994>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	500080e7          	jalr	1280(ra) # 5bdc <printf>
    exit(1);
    16e4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f2:	fb250513          	addi	a0,a0,-78 # 66a0 <malloc+0xa0c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	fe850513          	addi	a0,a0,-24 # 6700 <malloc+0xa6c>
    1720:	00004097          	auipc	ra,0x4
    1724:	4bc080e7          	jalr	1212(ra) # 5bdc <printf>
    exit(1);
    1728:	4505                	li	a0,1
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17dc:	f4050513          	addi	a0,a0,-192 # 6718 <malloc+0xa84>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	3fc080e7          	jalr	1020(ra) # 5bdc <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	ed250513          	addi	a0,a0,-302 # 6730 <malloc+0xa9c>
    1866:	00004097          	auipc	ra,0x4
    186a:	376080e7          	jalr	886(ra) # 5bdc <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	ece50513          	addi	a0,a0,-306 # 6748 <malloc+0xab4>
    1882:	00004097          	auipc	ra,0x4
    1886:	35a080e7          	jalr	858(ra) # 5bdc <printf>
}
    ...
    18b0:	eb450513          	addi	a0,a0,-332 # 6760 <malloc+0xacc>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	328080e7          	jalr	808(ra) # 5bdc <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	e9450513          	addi	a0,a0,-364 # 6780 <malloc+0xaec>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	2e8080e7          	jalr	744(ra) # 5bdc <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	cb250513          	addi	a0,a0,-846 # 6610 <malloc+0x97c>
    1966:	00004097          	auipc	ra,0x4
    196a:	276080e7          	jalr	630(ra) # 5bdc <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	e1e50513          	addi	a0,a0,-482 # 6798 <malloc+0xb04>
    1982:	00004097          	auipc	ra,0x4
    1986:	25a080e7          	jalr	602(ra) # 5bdc <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	e1a50513          	addi	a0,a0,-486 # 67b0 <malloc+0xb1c>
    199e:	00004097          	auipc	ra,0x4
    19a2:	23e080e7          	jalr	574(ra) # 5bdc <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	c0250513          	addi	a0,a0,-1022 # 6610 <malloc+0x97c>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	1c6080e7          	jalr	454(ra) # 5bdc <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	bde50513          	addi	a0,a0,-1058 # 6610 <malloc+0x97c>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	1a2080e7          	jalr	418(ra) # 5bdc <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	d2450513          	addi	a0,a0,-732 # 67d0 <malloc+0xb3c>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	128080e7          	jalr	296(ra) # 5bdc <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d84080e7          	jalr	-636(ra) # 5842 <exit>
{
    ...
    1b08:	cdc50513          	addi	a0,a0,-804 # 67e0 <malloc+0xb4c>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	0d0080e7          	jalr	208(ra) # 5bdc <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	ede50513          	addi	a0,a0,-290 # 6a30 <malloc+0xd9c>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	082080e7          	jalr	130(ra) # 5bdc <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	e4050513          	addi	a0,a0,-448 # 6a30 <malloc+0xd9c>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	fe4080e7          	jalr	-28(ra) # 5bdc <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	a8c50513          	addi	a0,a0,-1396 # 66a8 <malloc+0xa14>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	fb8080e7          	jalr	-72(ra) # 5bdc <printf>
          exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c92:	b7250513          	addi	a0,a0,-1166 # 6800 <malloc+0xb6c>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	f46080e7          	jalr	-186(ra) # 5bdc <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	b5650513          	addi	a0,a0,-1194 # 6818 <malloc+0xb84>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	f12080e7          	jalr	-238(ra) # 5bdc <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	b1850513          	addi	a0,a0,-1256 # 6840 <malloc+0xbac>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	eac080e7          	jalr	-340(ra) # 5bdc <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	06050513          	addi	a0,a0,96 # 5e28 <malloc+0x194>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e08:	024a8a93          	addi	s5,s5,36 # 5e28 <malloc+0x194>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	a5cb8b93          	addi	s7,s7,-1444 # 6868 <malloc+0xbd4>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00004517          	auipc	a0,0x4
    1e1c:	7f850513          	addi	a0,a0,2040 # 6610 <malloc+0x97c>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	dbc080e7          	jalr	-580(ra) # 5bdc <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	b2a50513          	addi	a0,a0,-1238 # 6a30 <malloc+0xd9c>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	cce080e7          	jalr	-818(ra) # 5bdc <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1fba:	8ba50513          	addi	a0,a0,-1862 # 6870 <malloc+0xbdc>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	c1e080e7          	jalr	-994(ra) # 5bdc <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	eb250513          	addi	a0,a0,-334 # 5e88 <malloc+0x1f4>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	bfe080e7          	jalr	-1026(ra) # 5bdc <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	87c50513          	addi	a0,a0,-1924 # 68a0 <malloc+0xc0c>
    202c:	00004097          	auipc	ra,0x4
    2030:	bb0080e7          	jalr	-1104(ra) # 5bdc <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	80250513          	addi	a0,a0,-2046 # 6888 <malloc+0xbf4>
    208e:	00004097          	auipc	ra,0x4
    2092:	b4e080e7          	jalr	-1202(ra) # 5bdc <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	82650513          	addi	a0,a0,-2010 # 68c8 <malloc+0xc34>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	b32080e7          	jalr	-1230(ra) # 5bdc <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	82250513          	addi	a0,a0,-2014 # 68e0 <malloc+0xc4c>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	b16080e7          	jalr	-1258(ra) # 5bdc <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	4d250513          	addi	a0,a0,1234 # 6610 <malloc+0x97c>
    2146:	00004097          	auipc	ra,0x4
    214a:	a96080e7          	jalr	-1386(ra) # 5bdc <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	79850513          	addi	a0,a0,1944 # 68f8 <malloc+0xc64>
    2168:	00004097          	auipc	ra,0x4
    216c:	a74080e7          	jalr	-1420(ra) # 5bdc <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	42e50513          	addi	a0,a0,1070 # 6610 <malloc+0x97c>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	9f2080e7          	jalr	-1550(ra) # 5bdc <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	70a50513          	addi	a0,a0,1802 # 6918 <malloc+0xc84>
    2216:	00004097          	auipc	ra,0x4
    221a:	9c6080e7          	jalr	-1594(ra) # 5bdc <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	6f250513          	addi	a0,a0,1778 # 6930 <malloc+0xc9c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	6c050513          	addi	a0,a0,1728 # 6930 <malloc+0xc9c>
  ...
  close(fd);
    ...
    22aa:	69a70713          	addi	a4,a4,1690 # 6940 <malloc+0xcac>
    ...
    22fe:	72650513          	addi	a0,a0,1830 # 6a20 <malloc+0xd8c>
    2302:	00004097          	auipc	ra,0x4
    2306:	8da080e7          	jalr	-1830(ra) # 5bdc <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	72250513          	addi	a0,a0,1826 # 6a40 <malloc+0xdac>
    2326:	00004097          	auipc	ra,0x4
    232a:	8b6080e7          	jalr	-1866(ra) # 5bdc <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2380:	6e450513          	addi	a0,a0,1764 # 6a60 <malloc+0xdcc>
    2384:	00004097          	auipc	ra,0x4
    2388:	858080e7          	jalr	-1960(ra) # 5bdc <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	27850513          	addi	a0,a0,632 # 6610 <malloc+0x97c>
    23a0:	00004097          	auipc	ra,0x4
    23a4:	83c080e7          	jalr	-1988(ra) # 5bdc <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	2d678793          	addi	a5,a5,726 # 7708 <malloc+0x1a74>
  ...
  if(ret != -1){
    ...
    2478:	61450513          	addi	a0,a0,1556 # 6a88 <malloc+0xdf4>
    247c:	00003097          	auipc	ra,0x3
    2480:	760080e7          	jalr	1888(ra) # 5bdc <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	09e50513          	addi	a0,a0,158 # 6530 <malloc+0x89c>
    249a:	00003097          	auipc	ra,0x3
    249e:	742080e7          	jalr	1858(ra) # 5bdc <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	0a050513          	addi	a0,a0,160 # 6550 <malloc+0x8bc>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	724080e7          	jalr	1828(ra) # 5bdc <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	0a050513          	addi	a0,a0,160 # 6570 <malloc+0x8dc>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	704080e7          	jalr	1796(ra) # 5bdc <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	0aa50513          	addi	a0,a0,170 # 6598 <malloc+0x904>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	6e6080e7          	jalr	1766(ra) # 5bdc <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	58e50513          	addi	a0,a0,1422 # 6ac8 <malloc+0xe34>
  ...
  if(n >= 0){
    ...
    256e:	57e50513          	addi	a0,a0,1406 # 6ae8 <malloc+0xe54>
    2572:	00003097          	auipc	ra,0x3
    2576:	66a080e7          	jalr	1642(ra) # 5bdc <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	50c50513          	addi	a0,a0,1292 # 6a90 <malloc+0xdfc>
    258c:	00003097          	auipc	ra,0x3
    2590:	650080e7          	jalr	1616(ra) # 5bdc <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	50a50513          	addi	a0,a0,1290 # 6aa8 <malloc+0xe14>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	636080e7          	jalr	1590(ra) # 5bdc <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	51850513          	addi	a0,a0,1304 # 6ad0 <malloc+0xe3c>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	61c080e7          	jalr	1564(ra) # 5bdc <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e0:	4ec50513          	addi	a0,a0,1260 # 6ac8 <malloc+0xe34>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	2ae080e7          	jalr	686(ra) # 5892 <unlink>
  fd = open("README", O_RDONLY);
    25ec:	4581                	li	a1,0
    25ee:	00004517          	auipc	a0,0x4
    25f2:	97250513          	addi	a0,a0,-1678 # 5f60 <malloc+0x2cc>
  ...
  if(n >= 0){
    ...
    261c:	50050513          	addi	a0,a0,1280 # 6b18 <malloc+0xe84>
    2620:	00003097          	auipc	ra,0x3
    2624:	5bc080e7          	jalr	1468(ra) # 5bdc <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	49e50513          	addi	a0,a0,1182 # 6ad0 <malloc+0xe3c>
    263a:	00003097          	auipc	ra,0x3
    263e:	5a2080e7          	jalr	1442(ra) # 5bdc <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26b6:	48e50513          	addi	a0,a0,1166 # 6b40 <malloc+0xeac>
    26ba:	00003097          	auipc	ra,0x3
    26be:	522080e7          	jalr	1314(ra) # 5bdc <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	45c50513          	addi	a0,a0,1116 # 6b60 <malloc+0xecc>
    270c:	00003097          	auipc	ra,0x3
    2710:	4d0080e7          	jalr	1232(ra) # 5bdc <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	45850513          	addi	a0,a0,1112 # 6bc0 <malloc+0xf2c>
    2770:	00003097          	auipc	ra,0x3
    2774:	46c080e7          	jalr	1132(ra) # 5bdc <printf>
    exit(1);
    2778:	4505                	li	a0,1
    ...
    278e:	3f650513          	addi	a0,a0,1014 # 6b80 <malloc+0xeec>
    2792:	00003097          	auipc	ra,0x3
    2796:	44a080e7          	jalr	1098(ra) # 5bdc <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	3fa50513          	addi	a0,a0,1018 # 6ba0 <malloc+0xf0c>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	42e080e7          	jalr	1070(ra) # 5bdc <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    28f4:	2f050513          	addi	a0,a0,752 # 6be0 <malloc+0xf4c>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	2e4080e7          	jalr	740(ra) # 5bdc <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	31c50513          	addi	a0,a0,796 # 6c28 <malloc+0xf94>
    2914:	00003097          	auipc	ra,0x3
    2918:	2c8080e7          	jalr	712(ra) # 5bdc <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	31c50513          	addi	a0,a0,796 # 6c48 <malloc+0xfb4>
    2934:	00003097          	auipc	ra,0x3
    2938:	2a8080e7          	jalr	680(ra) # 5bdc <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	33c50513          	addi	a0,a0,828 # 6c88 <malloc+0xff4>
    2954:	00003097          	auipc	ra,0x3
    2958:	288080e7          	jalr	648(ra) # 5bdc <printf>
    exit(1);
    295c:	4505                	li	a0,1
    ...
    296c:	35050513          	addi	a0,a0,848 # 6cb8 <malloc+0x1024>
    2970:	00003097          	auipc	ra,0x3
    2974:	26c080e7          	jalr	620(ra) # 5bdc <printf>
    exit(1);
    2978:	4505                	li	a0,1
    ...
    298c:	36850513          	addi	a0,a0,872 # 6cf0 <malloc+0x105c>
    2990:	00003097          	auipc	ra,0x3
    2994:	24c080e7          	jalr	588(ra) # 5bdc <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	35650513          	addi	a0,a0,854 # 6d18 <malloc+0x1084>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	eb8080e7          	jalr	-328(ra) # 5882 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	34450513          	addi	a0,a0,836 # 6d18 <malloc+0x1084>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	2f850513          	addi	a0,a0,760 # 6d20 <malloc+0x108c>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	1ac080e7          	jalr	428(ra) # 5bdc <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	2f450513          	addi	a0,a0,756 # 6d38 <malloc+0x10a4>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	190080e7          	jalr	400(ra) # 5bdc <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	cb850513          	addi	a0,a0,-840 # 6718 <malloc+0xa84>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	174080e7          	jalr	372(ra) # 5bdc <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	2c650513          	addi	a0,a0,710 # 6d50 <malloc+0x10bc>
  ...
  close(fd);
    ...
    2ad6:	b5650513          	addi	a0,a0,-1194 # 6628 <malloc+0x994>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	102080e7          	jalr	258(ra) # 5bdc <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	f1050513          	addi	a0,a0,-240 # 6a30 <malloc+0xd9c>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	0b4080e7          	jalr	180(ra) # 5bdc <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	eba50513          	addi	a0,a0,-326 # 6a30 <malloc+0xd9c>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	05e080e7          	jalr	94(ra) # 5bdc <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bda:	e5a50513          	addi	a0,a0,-422 # 6a30 <malloc+0xd9c>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	ffe080e7          	jalr	-2(ra) # 5bdc <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002cd6 <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cf6:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff11f7>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	ce650513          	addi	a0,a0,-794 # 6a30 <malloc+0xd9c>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	e8a080e7          	jalr	-374(ra) # 5bdc <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	01a50513          	addi	a0,a0,26 # 5db8 <malloc+0x124>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	07e78793          	addi	a5,a5,126 # 5e28 <malloc+0x194>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	14c50513          	addi	a0,a0,332 # 6f28 <malloc+0x1294>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	f9250513          	addi	a0,a0,-110 # 6d80 <malloc+0x10ec>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	fd450513          	addi	a0,a0,-44 # 6dd8 <malloc+0x1144>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	02e50513          	addi	a0,a0,46 # 6e50 <malloc+0x11bc>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	08250513          	addi	a0,a0,130 # 6ec0 <malloc+0x122c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	0c850513          	addi	a0,a0,200 # 6f18 <malloc+0x1284>
  ...
  unlink("12345678901234");
    ...
    2ed2:	e8a50513          	addi	a0,a0,-374 # 6d58 <malloc+0x10c4>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	d06080e7          	jalr	-762(ra) # 5bdc <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	eb650513          	addi	a0,a0,-330 # 6da0 <malloc+0x110c>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	cea080e7          	jalr	-790(ra) # 5bdc <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	f0250513          	addi	a0,a0,-254 # 6e08 <malloc+0x1174>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	cce080e7          	jalr	-818(ra) # 5bdc <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	f5e50513          	addi	a0,a0,-162 # 6e80 <malloc+0x11ec>
    2f2a:	00003097          	auipc	ra,0x3
    2f2e:	cb2080e7          	jalr	-846(ra) # 5bdc <printf>
    exit(1);
    2f32:	4505                	li	a0,1
    ...
    2f42:	fa250513          	addi	a0,a0,-94 # 6ee0 <malloc+0x124c>
    2f46:	00003097          	auipc	ra,0x3
    2f4a:	c96080e7          	jalr	-874(ra) # 5bdc <printf>
    exit(1);
    2f4e:	4505                	li	a0,1
    ...
    2f5e:	fde50513          	addi	a0,a0,-34 # 6f38 <malloc+0x12a4>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	c7a080e7          	jalr	-902(ra) # 5bdc <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	ff050513          	addi	a0,a0,-16 # 6f70 <malloc+0x12dc>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	fdc50513          	addi	a0,a0,-36 # 6f70 <malloc+0x12dc>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	00850513          	addi	a0,a0,8 # 6fb0 <malloc+0x131c>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	02450513          	addi	a0,a0,36 # 6fe0 <malloc+0x134c>
    ...
    2fe0:	f9c50513          	addi	a0,a0,-100 # 6f78 <malloc+0x12e4>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	bf8080e7          	jalr	-1032(ra) # 5bdc <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	f9850513          	addi	a0,a0,-104 # 6f90 <malloc+0x12fc>
    3000:	00003097          	auipc	ra,0x3
    3004:	bdc080e7          	jalr	-1060(ra) # 5bdc <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	fac50513          	addi	a0,a0,-84 # 6fc0 <malloc+0x132c>
    301c:	00003097          	auipc	ra,0x3
    3020:	bc0080e7          	jalr	-1088(ra) # 5bdc <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	fb850513          	addi	a0,a0,-72 # 6fe8 <malloc+0x1354>
    3038:	00003097          	auipc	ra,0x3
    303c:	ba4080e7          	jalr	-1116(ra) # 5bdc <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	f0c50513          	addi	a0,a0,-244 # 6f70 <malloc+0x12dc>
    ...
    307c:	ef850513          	addi	a0,a0,-264 # 6f70 <malloc+0x12dc>
    ...
    3090:	f2450513          	addi	a0,a0,-220 # 6fb0 <malloc+0x131c>
    ...
    30b0:	56450513          	addi	a0,a0,1380 # 6610 <malloc+0x97c>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	b28080e7          	jalr	-1240(ra) # 5bdc <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	eb050513          	addi	a0,a0,-336 # 6f78 <malloc+0x12e4>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	b0c080e7          	jalr	-1268(ra) # 5bdc <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	f1c50513          	addi	a0,a0,-228 # 7000 <malloc+0x136c>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	af0080e7          	jalr	-1296(ra) # 5bdc <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	ec050513          	addi	a0,a0,-320 # 6fc0 <malloc+0x132c>
    3108:	00003097          	auipc	ra,0x3
    310c:	ad4080e7          	jalr	-1324(ra) # 5bdc <printf>
      exit(1);
    3110:	4505                	li	a0,1
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	eda50513          	addi	a0,a0,-294 # 7018 <malloc+0x1384>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	ec650513          	addi	a0,a0,-314 # 7018 <malloc+0x1384>
  ...
  if(chdir("..") < 0){
    ...
    316a:	ed250513          	addi	a0,a0,-302 # 7038 <malloc+0x13a4>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	e9e50513          	addi	a0,a0,-354 # 7018 <malloc+0x1384>
    ...
    319e:	dde50513          	addi	a0,a0,-546 # 6f78 <malloc+0x12e4>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	a3a080e7          	jalr	-1478(ra) # 5bdc <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	e6a50513          	addi	a0,a0,-406 # 7020 <malloc+0x138c>
    31be:	00003097          	auipc	ra,0x3
    31c2:	a1e080e7          	jalr	-1506(ra) # 5bdc <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	e6e50513          	addi	a0,a0,-402 # 7040 <malloc+0x13ac>
    31da:	00003097          	auipc	ra,0x3
    31de:	a02080e7          	jalr	-1534(ra) # 5bdc <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	e6a50513          	addi	a0,a0,-406 # 7058 <malloc+0x13c4>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	9e6080e7          	jalr	-1562(ra) # 5bdc <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	f8a50513          	addi	a0,a0,-118 # 71a0 <malloc+0x150c>
    321e:	00002097          	auipc	ra,0x2
    3222:	674080e7          	jalr	1652(ra) # 5892 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	e4a50513          	addi	a0,a0,-438 # 7070 <malloc+0x13dc>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	e5250513          	addi	a0,a0,-430 # 7090 <malloc+0x13fc>
  ...
  write(fd, "ff", 2);
    ...
    325a:	f4a58593          	addi	a1,a1,-182 # 71a0 <malloc+0x150c>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	e0050513          	addi	a0,a0,-512 # 7070 <malloc+0x13dc>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	e6450513          	addi	a0,a0,-412 # 70e8 <malloc+0x1454>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e7450513          	addi	a0,a0,-396 # 7110 <malloc+0x147c>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	e8c58593          	addi	a1,a1,-372 # 7140 <malloc+0x14ac>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	e7850513          	addi	a0,a0,-392 # 7148 <malloc+0x14b4>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	e8058593          	addi	a1,a1,-384 # 7198 <malloc+0x1504>
    3320:	00004517          	auipc	a0,0x4
    3324:	df050513          	addi	a0,a0,-528 # 7110 <malloc+0x147c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	ddc50513          	addi	a0,a0,-548 # 7110 <malloc+0x147c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	dc650513          	addi	a0,a0,-570 # 7110 <malloc+0x147c>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	d1250513          	addi	a0,a0,-750 # 7070 <malloc+0x13dc>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	ebe50513          	addi	a0,a0,-322 # 7230 <malloc+0x159c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	eda50513          	addi	a0,a0,-294 # 7260 <malloc+0x15cc>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	ef650513          	addi	a0,a0,-266 # 7290 <malloc+0x15fc>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	de850513          	addi	a0,a0,-536 # 7198 <malloc+0x1504>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	d2650513          	addi	a0,a0,-730 # 7110 <malloc+0x147c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	f1e50513          	addi	a0,a0,-226 # 7320 <malloc+0x168c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	f3650513          	addi	a0,a0,-202 # 7350 <malloc+0x16bc>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	c3e50513          	addi	a0,a0,-962 # 7070 <malloc+0x13dc>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	c2850513          	addi	a0,a0,-984 # 7070 <malloc+0x13dc>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	c1250513          	addi	a0,a0,-1006 # 7070 <malloc+0x13dc>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	f6e58593          	addi	a1,a1,-146 # 73e0 <malloc+0x174c>
    347a:	00004517          	auipc	a0,0x4
    347e:	ea650513          	addi	a0,a0,-346 # 7320 <malloc+0x168c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	f5258593          	addi	a1,a1,-174 # 73e0 <malloc+0x174c>
    3496:	00004517          	auipc	a0,0x4
    349a:	eba50513          	addi	a0,a0,-326 # 7350 <malloc+0x16bc>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	cee58593          	addi	a1,a1,-786 # 7198 <malloc+0x1504>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	bde50513          	addi	a0,a0,-1058 # 7090 <malloc+0x13fc>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	e5a50513          	addi	a0,a0,-422 # 7320 <malloc+0x168c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	e7650513          	addi	a0,a0,-394 # 7350 <malloc+0x16bc>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	caa50513          	addi	a0,a0,-854 # 7198 <malloc+0x1504>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	e4e50513          	addi	a0,a0,-434 # 7350 <malloc+0x16bc>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	e0a50513          	addi	a0,a0,-502 # 7320 <malloc+0x168c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	b6650513          	addi	a0,a0,-1178 # 7090 <malloc+0x13fc>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	ff250513          	addi	a0,a0,-14 # 7530 <malloc+0x189c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	c4650513          	addi	a0,a0,-954 # 7198 <malloc+0x1504>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	b2a50513          	addi	a0,a0,-1238 # 7090 <malloc+0x13fc>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	af650513          	addi	a0,a0,-1290 # 7070 <malloc+0x13dc>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	01250513          	addi	a0,a0,18 # 75a0 <malloc+0x190c>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	ace50513          	addi	a0,a0,-1330 # 7070 <malloc+0x13dc>
    ...
    35c8:	ab450513          	addi	a0,a0,-1356 # 7078 <malloc+0x13e4>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	610080e7          	jalr	1552(ra) # 5bdc <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	ab850513          	addi	a0,a0,-1352 # 7098 <malloc+0x1404>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	5f4080e7          	jalr	1524(ra) # 5bdc <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	abc50513          	addi	a0,a0,-1348 # 70b8 <malloc+0x1424>
    3604:	00002097          	auipc	ra,0x2
    3608:	5d8080e7          	jalr	1496(ra) # 5bdc <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	ad850513          	addi	a0,a0,-1320 # 70f0 <malloc+0x145c>
    3620:	00002097          	auipc	ra,0x2
    3624:	5bc080e7          	jalr	1468(ra) # 5bdc <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	aec50513          	addi	a0,a0,-1300 # 7120 <malloc+0x148c>
    363c:	00002097          	auipc	ra,0x2
    3640:	5a0080e7          	jalr	1440(ra) # 5bdc <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	b0850513          	addi	a0,a0,-1272 # 7158 <malloc+0x14c4>
    3658:	00002097          	auipc	ra,0x2
    365c:	584080e7          	jalr	1412(ra) # 5bdc <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	b0c50513          	addi	a0,a0,-1268 # 7178 <malloc+0x14e4>
    3674:	00002097          	auipc	ra,0x2
    3678:	568080e7          	jalr	1384(ra) # 5bdc <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	b2050513          	addi	a0,a0,-1248 # 71a8 <malloc+0x1514>
    3690:	00002097          	auipc	ra,0x2
    3694:	54c080e7          	jalr	1356(ra) # 5bdc <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	b2c50513          	addi	a0,a0,-1236 # 71d0 <malloc+0x153c>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	530080e7          	jalr	1328(ra) # 5bdc <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	b3050513          	addi	a0,a0,-1232 # 71f0 <malloc+0x155c>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	514080e7          	jalr	1300(ra) # 5bdc <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	b3c50513          	addi	a0,a0,-1220 # 7218 <malloc+0x1584>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	4f8080e7          	jalr	1272(ra) # 5bdc <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	b4850513          	addi	a0,a0,-1208 # 7240 <malloc+0x15ac>
    3700:	00002097          	auipc	ra,0x2
    3704:	4dc080e7          	jalr	1244(ra) # 5bdc <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	b5c50513          	addi	a0,a0,-1188 # 7270 <malloc+0x15dc>
    371c:	00002097          	auipc	ra,0x2
    3720:	4c0080e7          	jalr	1216(ra) # 5bdc <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	b6850513          	addi	a0,a0,-1176 # 7298 <malloc+0x1604>
    3738:	00002097          	auipc	ra,0x2
    373c:	4a4080e7          	jalr	1188(ra) # 5bdc <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	b6450513          	addi	a0,a0,-1180 # 72b0 <malloc+0x161c>
    3754:	00002097          	auipc	ra,0x2
    3758:	488080e7          	jalr	1160(ra) # 5bdc <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	b6850513          	addi	a0,a0,-1176 # 72d0 <malloc+0x163c>
    3770:	00002097          	auipc	ra,0x2
    3774:	46c080e7          	jalr	1132(ra) # 5bdc <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	b6c50513          	addi	a0,a0,-1172 # 72f0 <malloc+0x165c>
    378c:	00002097          	auipc	ra,0x2
    3790:	450080e7          	jalr	1104(ra) # 5bdc <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	b9050513          	addi	a0,a0,-1136 # 7330 <malloc+0x169c>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	434080e7          	jalr	1076(ra) # 5bdc <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	ba450513          	addi	a0,a0,-1116 # 7360 <malloc+0x16cc>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	418080e7          	jalr	1048(ra) # 5bdc <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	ba850513          	addi	a0,a0,-1112 # 7380 <malloc+0x16ec>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	3fc080e7          	jalr	1020(ra) # 5bdc <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	bac50513          	addi	a0,a0,-1108 # 73a0 <malloc+0x170c>
    37fc:	00002097          	auipc	ra,0x2
    3800:	3e0080e7          	jalr	992(ra) # 5bdc <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	bb050513          	addi	a0,a0,-1104 # 73c0 <malloc+0x172c>
    3818:	00002097          	auipc	ra,0x2
    381c:	3c4080e7          	jalr	964(ra) # 5bdc <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	bc450513          	addi	a0,a0,-1084 # 73f0 <malloc+0x175c>
    3834:	00002097          	auipc	ra,0x2
    3838:	3a8080e7          	jalr	936(ra) # 5bdc <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	bd050513          	addi	a0,a0,-1072 # 7418 <malloc+0x1784>
    3850:	00002097          	auipc	ra,0x2
    3854:	38c080e7          	jalr	908(ra) # 5bdc <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	bdc50513          	addi	a0,a0,-1060 # 7440 <malloc+0x17ac>
    386c:	00002097          	auipc	ra,0x2
    3870:	370080e7          	jalr	880(ra) # 5bdc <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	be850513          	addi	a0,a0,-1048 # 7468 <malloc+0x17d4>
    3888:	00002097          	auipc	ra,0x2
    388c:	354080e7          	jalr	852(ra) # 5bdc <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	bec50513          	addi	a0,a0,-1044 # 7488 <malloc+0x17f4>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	338080e7          	jalr	824(ra) # 5bdc <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	bf050513          	addi	a0,a0,-1040 # 74a8 <malloc+0x1814>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	31c080e7          	jalr	796(ra) # 5bdc <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	bfc50513          	addi	a0,a0,-1028 # 74d0 <malloc+0x183c>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	300080e7          	jalr	768(ra) # 5bdc <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	c0050513          	addi	a0,a0,-1024 # 74f0 <malloc+0x185c>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	2e4080e7          	jalr	740(ra) # 5bdc <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	c0450513          	addi	a0,a0,-1020 # 7510 <malloc+0x187c>
    3914:	00002097          	auipc	ra,0x2
    3918:	2c8080e7          	jalr	712(ra) # 5bdc <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	c1050513          	addi	a0,a0,-1008 # 7538 <malloc+0x18a4>
    3930:	00002097          	auipc	ra,0x2
    3934:	2ac080e7          	jalr	684(ra) # 5bdc <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	88c50513          	addi	a0,a0,-1908 # 71d0 <malloc+0x153c>
    394c:	00002097          	auipc	ra,0x2
    3950:	290080e7          	jalr	656(ra) # 5bdc <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	bf850513          	addi	a0,a0,-1032 # 7558 <malloc+0x18c4>
    3968:	00002097          	auipc	ra,0x2
    396c:	274080e7          	jalr	628(ra) # 5bdc <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	bfc50513          	addi	a0,a0,-1028 # 7578 <malloc+0x18e4>
    3984:	00002097          	auipc	ra,0x2
    3988:	258080e7          	jalr	600(ra) # 5bdc <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	c1050513          	addi	a0,a0,-1008 # 75a8 <malloc+0x1914>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	23c080e7          	jalr	572(ra) # 5bdc <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	c1450513          	addi	a0,a0,-1004 # 75c8 <malloc+0x1934>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	220080e7          	jalr	544(ra) # 5bdc <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	c0650513          	addi	a0,a0,-1018 # 75e0 <malloc+0x194c>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	bf450513          	addi	a0,a0,-1036 # 75e0 <malloc+0x194c>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	a7250513          	addi	a0,a0,-1422 # 6470 <malloc+0x7dc>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	62850513          	addi	a0,a0,1576 # 7038 <malloc+0x13a4>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	5be50513          	addi	a0,a0,1470 # 6fe0 <malloc+0x134c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	c1450513          	addi	a0,a0,-1004 # 7648 <malloc+0x19b4>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	c2a50513          	addi	a0,a0,-982 # 7670 <malloc+0x19dc>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	b8850513          	addi	a0,a0,-1144 # 75e0 <malloc+0x194c>
    ...
    3a7a:	b7250513          	addi	a0,a0,-1166 # 75e8 <malloc+0x1954>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	15e080e7          	jalr	350(ra) # 5bdc <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	b6e50513          	addi	a0,a0,-1170 # 7600 <malloc+0x196c>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	142080e7          	jalr	322(ra) # 5bdc <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	b6a50513          	addi	a0,a0,-1174 # 7618 <malloc+0x1984>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	126080e7          	jalr	294(ra) # 5bdc <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	b6650513          	addi	a0,a0,-1178 # 7630 <malloc+0x199c>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	10a080e7          	jalr	266(ra) # 5bdc <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	50250513          	addi	a0,a0,1282 # 6fe8 <malloc+0x1354>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	0ee080e7          	jalr	238(ra) # 5bdc <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	b4e50513          	addi	a0,a0,-1202 # 7650 <malloc+0x19bc>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	0d2080e7          	jalr	210(ra) # 5bdc <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	b5a50513          	addi	a0,a0,-1190 # 7678 <malloc+0x19e4>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	0b6080e7          	jalr	182(ra) # 5bdc <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	b5e50513          	addi	a0,a0,-1186 # 7698 <malloc+0x1a04>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	09a080e7          	jalr	154(ra) # 5bdc <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	b5250513          	addi	a0,a0,-1198 # 76b8 <malloc+0x1a24>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	b3650513          	addi	a0,a0,-1226 # 76b8 <malloc+0x1a24>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	b6a50513          	addi	a0,a0,-1174 # 7700 <malloc+0x1a6c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	b5250513          	addi	a0,a0,-1198 # 7700 <malloc+0x1a6c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	b3e50513          	addi	a0,a0,-1218 # 7700 <malloc+0x1a6c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	b2a50513          	addi	a0,a0,-1238 # 7700 <malloc+0x1a6c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	b1658593          	addi	a1,a1,-1258 # 7700 <malloc+0x1a6c>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	36e50513          	addi	a0,a0,878 # 5f60 <malloc+0x2cc>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	ab250513          	addi	a0,a0,-1358 # 76b8 <malloc+0x1a24>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	85450513          	addi	a0,a0,-1964 # 6470 <malloc+0x7dc>
  ...
  fd = open(".", 0);
    ...
    3c36:	83e50513          	addi	a0,a0,-1986 # 6470 <malloc+0x7dc>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	1e258593          	addi	a1,a1,482 # 5e28 <malloc+0x194>
  ...
  close(fd);
    ...
    3c76:	a4e50513          	addi	a0,a0,-1458 # 76c0 <malloc+0x1a2c>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	f62080e7          	jalr	-158(ra) # 5bdc <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	a5250513          	addi	a0,a0,-1454 # 76e0 <malloc+0x1a4c>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	f46080e7          	jalr	-186(ra) # 5bdc <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	a6650513          	addi	a0,a0,-1434 # 7710 <malloc+0x1a7c>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	f2a080e7          	jalr	-214(ra) # 5bdc <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	a4a50513          	addi	a0,a0,-1462 # 7710 <malloc+0x1a7c>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	f0e080e7          	jalr	-242(ra) # 5bdc <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	a5650513          	addi	a0,a0,-1450 # 7738 <malloc+0x1aa4>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	ef2080e7          	jalr	-270(ra) # 5bdc <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	a6250513          	addi	a0,a0,-1438 # 7760 <malloc+0x1acc>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	ed6080e7          	jalr	-298(ra) # 5bdc <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	a6e50513          	addi	a0,a0,-1426 # 7788 <malloc+0x1af4>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	eba080e7          	jalr	-326(ra) # 5bdc <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	a7a50513          	addi	a0,a0,-1414 # 77b0 <malloc+0x1b1c>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	e9e080e7          	jalr	-354(ra) # 5bdc <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	a7e50513          	addi	a0,a0,-1410 # 77d0 <malloc+0x1b3c>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	e82080e7          	jalr	-382(ra) # 5bdc <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	a8a50513          	addi	a0,a0,-1398 # 77f8 <malloc+0x1b64>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	e66080e7          	jalr	-410(ra) # 5bdc <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	a6ea0a13          	addi	s4,s4,-1426 # 7810 <malloc+0x1b7c>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	56e48493          	addi	s1,s1,1390 # 7318 <malloc+0x1684>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	1aea8a93          	addi	s5,s5,430 # 5f60 <malloc+0x2cc>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	94e98993          	addi	s3,s3,-1714 # 7708 <malloc+0x1a74>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	a5250513          	addi	a0,a0,-1454 # 7818 <malloc+0x1b84>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	e0e080e7          	jalr	-498(ra) # 5bdc <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	a4e50513          	addi	a0,a0,-1458 # 7830 <malloc+0x1b9c>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	df2080e7          	jalr	-526(ra) # 5bdc <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	1c298993          	addi	s3,s3,450 # 7038 <malloc+0x13a4>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	99290913          	addi	s2,s2,-1646 # 7810 <malloc+0x1b7c>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	14250513          	addi	a0,a0,322 # 6fe0 <malloc+0x134c>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	97a50513          	addi	a0,a0,-1670 # 7848 <malloc+0x1bb4>
  ...
  if(pid == 0){
    ...
    3ef6:	95650513          	addi	a0,a0,-1706 # 7848 <malloc+0x1bb4>
    ...
    3f0c:	96050513          	addi	a0,a0,-1696 # 7868 <malloc+0x1bd4>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	ccc080e7          	jalr	-820(ra) # 5bdc <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	92c50513          	addi	a0,a0,-1748 # 7850 <malloc+0x1bbc>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	cb0080e7          	jalr	-848(ra) # 5bdc <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	6d050513          	addi	a0,a0,1744 # 6610 <malloc+0x97c>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	c94080e7          	jalr	-876(ra) # 5bdc <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	8da50513          	addi	a0,a0,-1830 # 7848 <malloc+0x1bb4>
    ...
    3f86:	87e50513          	addi	a0,a0,-1922 # 6800 <malloc+0xb6c>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	c52080e7          	jalr	-942(ra) # 5bdc <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	8d050513          	addi	a0,a0,-1840 # 7890 <malloc+0x1bfc>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	8a450513          	addi	a0,a0,-1884 # 7890 <malloc+0x1bfc>
  ...
  sleep(10); // one second
    ...
    4028:	7ac50513          	addi	a0,a0,1964 # 67d0 <malloc+0xb3c>
    402c:	00002097          	auipc	ra,0x2
    4030:	bb0080e7          	jalr	-1104(ra) # 5bdc <printf>
    exit(1);
    4034:	4505                	li	a0,1
    ...
    4042:	85248493          	addi	s1,s1,-1966 # 7890 <malloc+0x1bfc>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
...
0000000000004084 <killstatus>:
{
  ...
  exit(0);
    ...
    40ea:	52a50513          	addi	a0,a0,1322 # 6610 <malloc+0x97c>
    40ee:	00002097          	auipc	ra,0x2
    40f2:	aee080e7          	jalr	-1298(ra) # 5bdc <printf>
      exit(1);
    40f6:	4505                	li	a0,1
    ...
    4110:	79450513          	addi	a0,a0,1940 # 78a0 <malloc+0x1c0c>
    4114:	00002097          	auipc	ra,0x2
    4118:	ac8080e7          	jalr	-1336(ra) # 5bdc <printf>
       exit(1);
    411c:	4505                	li	a0,1
...
0000000000004126 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4150:	68450513          	addi	a0,a0,1668 # 67d0 <malloc+0xb3c>
    4154:	00002097          	auipc	ra,0x2
    4158:	a88080e7          	jalr	-1400(ra) # 5bdc <printf>
    exit(1);
    415c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    417e:	49650513          	addi	a0,a0,1174 # 6610 <malloc+0x97c>
    4182:	00002097          	auipc	ra,0x2
    4186:	a5a080e7          	jalr	-1446(ra) # 5bdc <printf>
    exit(1);
    418a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c2:	c6a58593          	addi	a1,a1,-918 # 5e28 <malloc+0x194>
    ...
    41ec:	42850513          	addi	a0,a0,1064 # 6610 <malloc+0x97c>
    41f0:	00002097          	auipc	ra,0x2
    41f4:	9ec080e7          	jalr	-1556(ra) # 5bdc <printf>
     exit(1);
    41f8:	4505                	li	a0,1
    ...
    4208:	6bc50513          	addi	a0,a0,1724 # 78c0 <malloc+0x1c2c>
    420c:	00002097          	auipc	ra,0x2
    4210:	9d0080e7          	jalr	-1584(ra) # 5bdc <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4244:	69850513          	addi	a0,a0,1688 # 78d8 <malloc+0x1c44>
    4248:	00002097          	auipc	ra,0x2
    424c:	994080e7          	jalr	-1644(ra) # 5bdc <printf>
}
  ...
  printf("kill... ");
    ...
    4270:	68450513          	addi	a0,a0,1668 # 78f0 <malloc+0x1c5c>
    4274:	00002097          	auipc	ra,0x2
    4278:	968080e7          	jalr	-1688(ra) # 5bdc <printf>
  kill(pid1);
    427c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    429e:	66650513          	addi	a0,a0,1638 # 7900 <malloc+0x1c6c>
    42a2:	00002097          	auipc	ra,0x2
    42a6:	93a080e7          	jalr	-1734(ra) # 5bdc <printf>
  wait(0);
    42aa:	4501                	li	a0,0
...
00000000000042ca <reparent>:
{
  ...
  exit(0);
    ...
    431e:	2f650513          	addi	a0,a0,758 # 6610 <malloc+0x97c>
    4322:	00002097          	auipc	ra,0x2
    4326:	8ba080e7          	jalr	-1862(ra) # 5bdc <printf>
      exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	46250513          	addi	a0,a0,1122 # 6798 <malloc+0xb04>
    433e:	00002097          	auipc	ra,0x2
    4342:	89e080e7          	jalr	-1890(ra) # 5bdc <printf>
        exit(1);
    4346:	4505                	li	a0,1
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b0:	36c50513          	addi	a0,a0,876 # 6718 <malloc+0xa84>
    43b4:	00002097          	auipc	ra,0x2
    43b8:	828080e7          	jalr	-2008(ra) # 5bdc <printf>
    exit(1);
    43bc:	4505                	li	a0,1
    ...
    43e4:	a4858593          	addi	a1,a1,-1464 # 5e28 <malloc+0x194>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44a8:	46c50513          	addi	a0,a0,1132 # 7910 <malloc+0x1c7c>
    44ac:	00001097          	auipc	ra,0x1
    44b0:	730080e7          	jalr	1840(ra) # 5bdc <printf>
    exit(1);
    44b4:	4505                	li	a0,1
    ...
    44c4:	15050513          	addi	a0,a0,336 # 6610 <malloc+0x97c>
    44c8:	00001097          	auipc	ra,0x1
    44cc:	714080e7          	jalr	1812(ra) # 5bdc <printf>
    exit(1);
    44d0:	4505                	li	a0,1
    ...
    4510:	42450513          	addi	a0,a0,1060 # 7930 <malloc+0x1c9c>
    4514:	00001097          	auipc	ra,0x1
    4518:	6c8080e7          	jalr	1736(ra) # 5bdc <printf>
    exit(1);
    451c:	4505                	li	a0,1
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    457a:	71e080e7          	jalr	1822(ra) # 5c94 <malloc>
    ...
    45b4:	3b050513          	addi	a0,a0,944 # 7960 <malloc+0x1ccc>
    45b8:	00001097          	auipc	ra,0x1
    45bc:	624080e7          	jalr	1572(ra) # 5bdc <printf>
      exit(1);
    45c0:	4505                	li	a0,1
...
00000000000045d4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    466a:	32a50513          	addi	a0,a0,810 # 7990 <malloc+0x1cfc>
    466e:	00001097          	auipc	ra,0x1
    4672:	56e080e7          	jalr	1390(ra) # 5bdc <printf>
    exit(1);
    4676:	4505                	li	a0,1
    ...
    4686:	33650513          	addi	a0,a0,822 # 79b8 <malloc+0x1d24>
    468a:	00001097          	auipc	ra,0x1
    468e:	552080e7          	jalr	1362(ra) # 5bdc <printf>
      exit(1);
    4692:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46ca:	2ba50513          	addi	a0,a0,698 # 7980 <malloc+0x1cec>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    470a:	2d250513          	addi	a0,a0,722 # 79d8 <malloc+0x1d44>
    470e:	00001097          	auipc	ra,0x1
    4712:	4ce080e7          	jalr	1230(ra) # 5bdc <printf>
    exit(1);
    4716:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4746:	23e50513          	addi	a0,a0,574 # 7980 <malloc+0x1cec>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    476c:	29850513          	addi	a0,a0,664 # 7a00 <malloc+0x1d6c>
    4770:	00001097          	auipc	ra,0x1
    4774:	46c080e7          	jalr	1132(ra) # 5bdc <printf>
    exit(1);
    4778:	4505                	li	a0,1
...
000000000000478c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b2:	26a78793          	addi	a5,a5,618 # 7a18 <malloc+0x1d84>
    47b6:	f6f43823          	sd	a5,-144(s0)
    47ba:	00003797          	auipc	a5,0x3
    47be:	26678793          	addi	a5,a5,614 # 7a20 <malloc+0x1d8c>
    47c2:	f6f43c23          	sd	a5,-136(s0)
    47c6:	00003797          	auipc	a5,0x3
    47ca:	26278793          	addi	a5,a5,610 # 7a28 <malloc+0x1d94>
    47ce:	f8f43023          	sd	a5,-128(s0)
    47d2:	00003797          	auipc	a5,0x3
    47d6:	25e78793          	addi	a5,a5,606 # 7a30 <malloc+0x1d9c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    484e:	1e650513          	addi	a0,a0,486 # 6a30 <malloc+0xd9c>
    4852:	00001097          	auipc	ra,0x1
    4856:	38a080e7          	jalr	906(ra) # 5bdc <printf>
      exit(1);
    485a:	4505                	li	a0,1
    ...
    48ca:	17250513          	addi	a0,a0,370 # 7a38 <malloc+0x1da4>
    48ce:	00001097          	auipc	ra,0x1
    48d2:	30e080e7          	jalr	782(ra) # 5bdc <printf>
        exit(1);
    48d6:	4505                	li	a0,1
    ...
    48e4:	16850513          	addi	a0,a0,360 # 7a48 <malloc+0x1db4>
    48e8:	00001097          	auipc	ra,0x1
    48ec:	2f4080e7          	jalr	756(ra) # 5bdc <printf>
          exit(1);
    48f0:	4505                	li	a0,1
    ...
    490c:	15850513          	addi	a0,a0,344 # 7a60 <malloc+0x1dcc>
    4910:	00001097          	auipc	ra,0x1
    4914:	2cc080e7          	jalr	716(ra) # 5bdc <printf>
          exit(1);
    4918:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    499a:	0da50513          	addi	a0,a0,218 # 7a70 <malloc+0x1ddc>
    499e:	00001097          	auipc	ra,0x1
    49a2:	23e080e7          	jalr	574(ra) # 5bdc <printf>
      exit(1);
    49a6:	4505                	li	a0,1
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49fc:	090b8b93          	addi	s7,s7,144 # 7a88 <malloc+0x1df4>
  for(i = 0; i < N; i++){
    ...
    4a3e:	05650513          	addi	a0,a0,86 # 7a90 <malloc+0x1dfc>
    4a42:	00001097          	auipc	ra,0x1
    4a46:	19a080e7          	jalr	410(ra) # 5bdc <printf>
        exit(1);
    4a4a:	4505                	li	a0,1
    ...
    4a5c:	03050513          	addi	a0,a0,48 # 7a88 <malloc+0x1df4>
  ...
  fd = open(".", 0);
    ...
    4a94:	9e050513          	addi	a0,a0,-1568 # 6470 <malloc+0x7dc>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b0c:	fa850513          	addi	a0,a0,-88 # 7ab0 <malloc+0x1e1c>
    4b10:	00001097          	auipc	ra,0x1
    4b14:	0cc080e7          	jalr	204(ra) # 5bdc <printf>
        exit(1);
    4b18:	4505                	li	a0,1
    ...
    4b2c:	fa850513          	addi	a0,a0,-88 # 7ad0 <malloc+0x1e3c>
    4b30:	00001097          	auipc	ra,0x1
    4b34:	0ac080e7          	jalr	172(ra) # 5bdc <printf>
        exit(1);
    4b38:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b64:	f9850513          	addi	a0,a0,-104 # 7af8 <malloc+0x1e64>
    4b68:	00001097          	auipc	ra,0x1
    4b6c:	074080e7          	jalr	116(ra) # 5bdc <printf>
    exit(1);
    4b70:	4505                	li	a0,1
    ...
    4b80:	a9450513          	addi	a0,a0,-1388 # 6610 <malloc+0x97c>
    4b84:	00001097          	auipc	ra,0x1
    4b88:	058080e7          	jalr	88(ra) # 5bdc <printf>
      exit(1);
    4b8c:	4505                	li	a0,1
...
0000000000004d2a <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db2:	d8250513          	addi	a0,a0,-638 # 7b30 <malloc+0x1e9c>
  ...
  for(i = 0; ; i++){
    ...
    4e16:	d2e50513          	addi	a0,a0,-722 # 7b40 <malloc+0x1eac>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	dc2080e7          	jalr	-574(ra) # 5bdc <printf>
    exit(1);
    4e22:	4505                	li	a0,1
    ...
    4e32:	d3250513          	addi	a0,a0,-718 # 7b60 <malloc+0x1ecc>
    4e36:	00001097          	auipc	ra,0x1
    4e3a:	da6080e7          	jalr	-602(ra) # 5bdc <printf>
      exit(1);
    4e3e:	4505                	li	a0,1
    ...
    4e4e:	d3650513          	addi	a0,a0,-714 # 7b80 <malloc+0x1eec>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	d8a080e7          	jalr	-630(ra) # 5bdc <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    ...
    4e6a:	d3a50513          	addi	a0,a0,-710 # 7ba0 <malloc+0x1f0c>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	d6e080e7          	jalr	-658(ra) # 5bdc <printf>
      exit(1);
    4e76:	4505                	li	a0,1
    ...
    4e86:	d3e50513          	addi	a0,a0,-706 # 7bc0 <malloc+0x1f2c>
    4e8a:	00001097          	auipc	ra,0x1
    4e8e:	d52080e7          	jalr	-686(ra) # 5bdc <printf>
      exit(1);
    4e92:	4505                	li	a0,1
    ...
    4ea2:	d3a50513          	addi	a0,a0,-710 # 7bd8 <malloc+0x1f44>
    4ea6:	00001097          	auipc	ra,0x1
    4eaa:	d36080e7          	jalr	-714(ra) # 5bdc <printf>
      exit(1);
    4eae:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed0:	c6450513          	addi	a0,a0,-924 # 7b30 <malloc+0x1e9c>
    ...
    4ef4:	d0850513          	addi	a0,a0,-760 # 7bf8 <malloc+0x1f64>
    4ef8:	00001097          	auipc	ra,0x1
    4efc:	ce4080e7          	jalr	-796(ra) # 5bdc <printf>
    exit(1);
    4f00:	4505                	li	a0,1
...
0000000000004f0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f2c:	cf050513          	addi	a0,a0,-784 # 7c18 <malloc+0x1f84>
    4f30:	00001097          	auipc	ra,0x1
    4f34:	cac080e7          	jalr	-852(ra) # 5bdc <printf>
  for(nfiles = 0; ; nfiles++){
    4f38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f4c:	ce0c8c93          	addi	s9,s9,-800 # 7c28 <malloc+0x1f94>
    int total = 0;
    4f50:	4d81                	li	s11,0
    ...
    4fa4:	c3c080e7          	jalr	-964(ra) # 5bdc <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fc6:	c7650513          	addi	a0,a0,-906 # 7c38 <malloc+0x1fa4>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	c12080e7          	jalr	-1006(ra) # 5bdc <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    503c:	c2050513          	addi	a0,a0,-992 # 7c58 <malloc+0x1fc4>
    5040:	00001097          	auipc	ra,0x1
    5044:	b9c080e7          	jalr	-1124(ra) # 5bdc <printf>
}
    ...
    508c:	bc050513          	addi	a0,a0,-1088 # 7c48 <malloc+0x1fb4>
    5090:	00001097          	auipc	ra,0x1
    5094:	b4c080e7          	jalr	-1204(ra) # 5bdc <printf>
    close(fd);
    5098:	854a                	mv	a0,s2
...
00000000000050aa <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    511e:	b5650513          	addi	a0,a0,-1194 # 7c70 <malloc+0x1fdc>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5136:	cf658593          	addi	a1,a1,-778 # 5e28 <malloc+0x194>
    ...
    514c:	b4850513          	addi	a0,a0,-1208 # 7c90 <malloc+0x1ffc>
    5150:	00001097          	auipc	ra,0x1
    5154:	a8c080e7          	jalr	-1396(ra) # 5bdc <printf>
    exit(1);
    5158:	4505                	li	a0,1
    ...
    5166:	b1650513          	addi	a0,a0,-1258 # 7c78 <malloc+0x1fe4>
    516a:	00001097          	auipc	ra,0x1
    516e:	a72080e7          	jalr	-1422(ra) # 5bdc <printf>
      exit(1);
    5172:	4505                	li	a0,1
    ...
    5180:	afc50513          	addi	a0,a0,-1284 # 7c78 <malloc+0x1fe4>
    5184:	00001097          	auipc	ra,0x1
    5188:	a58080e7          	jalr	-1448(ra) # 5bdc <printf>
    exit(1);
    518c:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a4:	ad050513          	addi	a0,a0,-1328 # 7c70 <malloc+0x1fdc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fa:	c3298993          	addi	s3,s3,-974 # 5e28 <malloc+0x194>
      uint64 a = (uint64) sbrk(4096);
    ...
    522c:	ab850513          	addi	a0,a0,-1352 # 7ce0 <malloc+0x204c>
    5230:	00001097          	auipc	ra,0x1
    5234:	9ac080e7          	jalr	-1620(ra) # 5bdc <printf>
        exit(1);
    5238:	4505                	li	a0,1
    ...
    5246:	a5e50513          	addi	a0,a0,-1442 # 7ca0 <malloc+0x200c>
    524a:	00001097          	auipc	ra,0x1
    524e:	992080e7          	jalr	-1646(ra) # 5bdc <printf>
    exit(1);
    5252:	4505                	li	a0,1
    ...
    5260:	a6450513          	addi	a0,a0,-1436 # 7cc0 <malloc+0x202c>
    5264:	00001097          	auipc	ra,0x1
    5268:	978080e7          	jalr	-1672(ra) # 5bdc <printf>
    exit(1);
    526c:	4505                	li	a0,1
  ...
  while(1){
    ...
    52ae:	a5650513          	addi	a0,a0,-1450 # 7d00 <malloc+0x206c>
    52b2:	00001097          	auipc	ra,0x1
    52b6:	92a080e7          	jalr	-1750(ra) # 5bdc <printf>
      exit(1);
    52ba:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52fe:	a2650513          	addi	a0,a0,-1498 # 7d20 <malloc+0x208c>
    5302:	00001097          	auipc	ra,0x1
    5306:	8da080e7          	jalr	-1830(ra) # 5bdc <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    532e:	a1e50513          	addi	a0,a0,-1506 # 7d48 <malloc+0x20b4>
    5332:	00001097          	auipc	ra,0x1
    5336:	8aa080e7          	jalr	-1878(ra) # 5bdc <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5352:	9e250513          	addi	a0,a0,-1566 # 7d30 <malloc+0x209c>
    5356:	00001097          	auipc	ra,0x1
    535a:	886080e7          	jalr	-1914(ra) # 5bdc <printf>
    exit(1);
    535e:	4505                	li	a0,1
    ...
    537a:	9da50513          	addi	a0,a0,-1574 # 7d50 <malloc+0x20bc>
    537e:	00001097          	auipc	ra,0x1
    5382:	85e080e7          	jalr	-1954(ra) # 5bdc <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c4:	da878793          	addi	a5,a5,-600 # 8168 <malloc+0x24d4>
    53c8:	bd040713          	addi	a4,s0,-1072
    53cc:	00003317          	auipc	t1,0x3
    53d0:	18c30313          	addi	t1,t1,396 # 8558 <malloc+0x28c4>
  ...
  printf("usertests starting\n");
    ...
    5404:	a0850513          	addi	a0,a0,-1528 # 7e08 <malloc+0x2174>
    5408:	00000097          	auipc	ra,0x0
    540c:	7d4080e7          	jalr	2004(ra) # 5bdc <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    543c:	98850513          	addi	a0,a0,-1656 # 7dc0 <malloc+0x212c>
    5440:	00000097          	auipc	ra,0x0
    5444:	79c080e7          	jalr	1948(ra) # 5bdc <printf>
    exit(1);
    5448:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5458:	90458593          	addi	a1,a1,-1788 # 7d58 <malloc+0x20c4>
    ...
    546e:	9d658593          	addi	a1,a1,-1578 # 7e40 <malloc+0x21ac>
    ...
    5492:	8d250513          	addi	a0,a0,-1838 # 7d60 <malloc+0x20cc>
    5496:	00000097          	auipc	ra,0x0
    549a:	746080e7          	jalr	1862(ra) # 5bdc <printf>
    exit(1);
    549e:	4505                	li	a0,1
    ...
    54bc:	724080e7          	jalr	1828(ra) # 5bdc <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    54fe:	8ae50513          	addi	a0,a0,-1874 # 7da8 <malloc+0x2114>
    5502:	00000097          	auipc	ra,0x0
    5506:	6da080e7          	jalr	1754(ra) # 5bdc <printf>
    exit(1);
    550a:	4505                	li	a0,1
    ...
    5518:	8dc50513          	addi	a0,a0,-1828 # 7df0 <malloc+0x215c>
    551c:	00000097          	auipc	ra,0x0
    5520:	6c0080e7          	jalr	1728(ra) # 5bdc <printf>
    exit(0);
    5524:	4501                	li	a0,0
    ...
    5534:	6ac080e7          	jalr	1708(ra) # 5bdc <printf>
        if(continuous != 2)
    ...
    5576:	bf678793          	addi	a5,a5,-1034 # 8168 <malloc+0x24d4>
    557a:	bd040713          	addi	a4,s0,-1072
    557e:	00003317          	auipc	t1,0x3
    5582:	fda30313          	addi	t1,t1,-38 # 8558 <malloc+0x28c4>
    ...
    55b6:	86e50513          	addi	a0,a0,-1938 # 7e20 <malloc+0x218c>
    55ba:	00000097          	auipc	ra,0x0
    55be:	622080e7          	jalr	1570(ra) # 5bdc <printf>
        printf("SOME TESTS FAILED\n");
    55c2:	00002a97          	auipc	s5,0x2
    55c6:	7e6a8a93          	addi	s5,s5,2022 # 7da8 <malloc+0x2114>
        if(continuous != 2)
    55ca:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55cc:	00002b17          	auipc	s6,0x2
    55d0:	7bcb0b13          	addi	s6,s6,1980 # 7d88 <malloc+0x20f4>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5918:	f4e080e7          	jalr	-178(ra) # 5862 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    5936:	0805c963          	bltz	a1,59c8 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    ...
    594a:	c7250513          	addi	a0,a0,-910 # 85b8 <digits>
    594e:	883a                	mv	a6,a4
  ...
  if(neg)
    5972:	00088c63          	beqz	a7,598a <printint+0x66>
    buf[i++] = '-';
    5976:	fd070793          	addi	a5,a4,-48
    597a:	00878733          	add	a4,a5,s0
    597e:	02d00793          	li	a5,45
    5982:	fef70823          	sb	a5,-16(a4)
    5986:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    598a:	02e05863          	blez	a4,59ba <printint+0x96>
    598e:	fc040793          	addi	a5,s0,-64
    5992:	00e78933          	add	s2,a5,a4
    5996:	fff78993          	addi	s3,a5,-1
    599a:	99ba                	add	s3,s3,a4
    599c:	377d                	addiw	a4,a4,-1
    599e:	1702                	slli	a4,a4,0x20
    59a0:	9301                	srli	a4,a4,0x20
    59a2:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    59a6:	fff94583          	lbu	a1,-1(s2)
    59aa:	8526                	mv	a0,s1
    59ac:	00000097          	auipc	ra,0x0
    59b0:	f56080e7          	jalr	-170(ra) # 5902 <putc>
  while(--i >= 0)
    59b4:	197d                	addi	s2,s2,-1
    59b6:	ff3918e3          	bne	s2,s3,59a6 <printint+0x82>
}
    ...
    59c4:	6121                	addi	sp,sp,64
    59c6:	8082                	ret
    x = -xx;
    59c8:	40b005bb          	negw	a1,a1
    neg = 1;
    59cc:	4885                	li	a7,1
    x = -xx;
    59ce:	bf85                	j	593e <printint+0x1a>

00000000000059d0 <vprintf>:
}
...
{
    59d0:	7119                	addi	sp,sp,-128
    59d2:	fc86                	sd	ra,120(sp)
    59d4:	f8a2                	sd	s0,112(sp)
    59d6:	f4a6                	sd	s1,104(sp)
    59d8:	f0ca                	sd	s2,96(sp)
    59da:	ecce                	sd	s3,88(sp)
    59dc:	e8d2                	sd	s4,80(sp)
    59de:	e4d6                	sd	s5,72(sp)
    59e0:	e0da                	sd	s6,64(sp)
    59e2:	fc5e                	sd	s7,56(sp)
    59e4:	f862                	sd	s8,48(sp)
    59e6:	f466                	sd	s9,40(sp)
    59e8:	f06a                	sd	s10,32(sp)
    59ea:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    59ee:	0005c903          	lbu	s2,0(a1)
    59f2:	18090f63          	beqz	s2,5b90 <vprintf+0x1c0>
    59f6:	8aaa                	mv	s5,a0
    59f8:	8b32                	mv	s6,a2
    59fa:	00158493          	addi	s1,a1,1
  state = 0;
    59fe:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5a00:	02500a13          	li	s4,37
    5a04:	4c55                	li	s8,21
    5a06:	00003c97          	auipc	s9,0x3
    5a0a:	b5ac8c93          	addi	s9,s9,-1190 # 8560 <malloc+0x28cc>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5a0e:	02800d93          	li	s11,40
  putc(fd, 'x');
    5a12:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a14:	00003b97          	auipc	s7,0x3
    5a18:	ba4b8b93          	addi	s7,s7,-1116 # 85b8 <digits>
    5a1c:	a839                	j	5a3a <vprintf+0x6a>
        putc(fd, c);
    5a1e:	85ca                	mv	a1,s2
    5a20:	8556                	mv	a0,s5
    5a22:	00000097          	auipc	ra,0x0
    5a26:	ee0080e7          	jalr	-288(ra) # 5902 <putc>
    5a2a:	a019                	j	5a30 <vprintf+0x60>
    } else if(state == '%'){
    5a2c:	01498d63          	beq	s3,s4,5a46 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5a30:	0485                	addi	s1,s1,1
    5a32:	fff4c903          	lbu	s2,-1(s1)
    5a36:	14090d63          	beqz	s2,5b90 <vprintf+0x1c0>
    if(state == 0){
    5a3a:	fe0999e3          	bnez	s3,5a2c <vprintf+0x5c>
      if(c == '%'){
    5a3e:	ff4910e3          	bne	s2,s4,5a1e <vprintf+0x4e>
        state = '%';
    5a42:	89d2                	mv	s3,s4
    5a44:	b7f5                	j	5a30 <vprintf+0x60>
      if(c == 'd'){
    5a46:	11490c63          	beq	s2,s4,5b5e <vprintf+0x18e>
    5a4a:	f9d9079b          	addiw	a5,s2,-99
    5a4e:	0ff7f793          	zext.b	a5,a5
    5a52:	10fc6e63          	bltu	s8,a5,5b6e <vprintf+0x19e>
    5a56:	f9d9079b          	addiw	a5,s2,-99
    5a5a:	0ff7f713          	zext.b	a4,a5
    5a5e:	10ec6863          	bltu	s8,a4,5b6e <vprintf+0x19e>
    5a62:	00271793          	slli	a5,a4,0x2
    5a66:	97e6                	add	a5,a5,s9
    5a68:	439c                	lw	a5,0(a5)
    5a6a:	97e6                	add	a5,a5,s9
    5a6c:	8782                	jr	a5
    ...
    5a80:	ea8080e7          	jalr	-344(ra) # 5924 <printint>
    5a84:	8b4a                	mv	s6,s2
      } else {
    ...
    5a9c:	e8c080e7          	jalr	-372(ra) # 5924 <printint>
    5aa0:	8b4a                	mv	s6,s2
      state = 0;
    5aa2:	4981                	li	s3,0
    5aa4:	b771                	j	5a30 <vprintf+0x60>
    ...
    5ab8:	e70080e7          	jalr	-400(ra) # 5924 <printint>
    5abc:	8b4a                	mv	s6,s2
      state = 0;
    5abe:	4981                	li	s3,0
    5ac0:	bf85                	j	5a30 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    5ad8:	e2e080e7          	jalr	-466(ra) # 5902 <putc>
  putc(fd, 'x');
    5adc:	07800593          	li	a1,120
    5ae0:	8556                	mv	a0,s5
    5ae2:	00000097          	auipc	ra,0x0
    5ae6:	e20080e7          	jalr	-480(ra) # 5902 <putc>
    5aea:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5aec:	03c9d793          	srli	a5,s3,0x3c
    5af0:	97de                	add	a5,a5,s7
    5af2:	0007c583          	lbu	a1,0(a5)
    5af6:	8556                	mv	a0,s5
    5af8:	00000097          	auipc	ra,0x0
    5afc:	e0a080e7          	jalr	-502(ra) # 5902 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b00:	0992                	slli	s3,s3,0x4
    5b02:	397d                	addiw	s2,s2,-1
    5b04:	fe0914e3          	bnez	s2,5aec <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5b08:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b0c:	4981                	li	s3,0
    5b0e:	b70d                	j	5a30 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b10:	008b0913          	addi	s2,s6,8
    5b14:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5b18:	02098163          	beqz	s3,5b3a <vprintf+0x16a>
        while(*s != 0){
    5b1c:	0009c583          	lbu	a1,0(s3)
    5b20:	c5ad                	beqz	a1,5b8a <vprintf+0x1ba>
          putc(fd, *s);
    5b22:	8556                	mv	a0,s5
    5b24:	00000097          	auipc	ra,0x0
    5b28:	dde080e7          	jalr	-546(ra) # 5902 <putc>
          s++;
    5b2c:	0985                	addi	s3,s3,1
        while(*s != 0){
    5b2e:	0009c583          	lbu	a1,0(s3)
    5b32:	f9e5                	bnez	a1,5b22 <vprintf+0x152>
        s = va_arg(ap, char*);
    5b34:	8b4a                	mv	s6,s2
      state = 0;
    5b36:	4981                	li	s3,0
    5b38:	bde5                	j	5a30 <vprintf+0x60>
          s = "(null)";
    5b3a:	00003997          	auipc	s3,0x3
    5b3e:	a1e98993          	addi	s3,s3,-1506 # 8558 <malloc+0x28c4>
        while(*s != 0){
    5b42:	85ee                	mv	a1,s11
    5b44:	bff9                	j	5b22 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5b46:	008b0913          	addi	s2,s6,8
    5b4a:	000b4583          	lbu	a1,0(s6)
    5b4e:	8556                	mv	a0,s5
    5b50:	00000097          	auipc	ra,0x0
    5b54:	db2080e7          	jalr	-590(ra) # 5902 <putc>
    5b58:	8b4a                	mv	s6,s2
      state = 0;
    5b5a:	4981                	li	s3,0
    5b5c:	bdd1                	j	5a30 <vprintf+0x60>
        putc(fd, c);
    5b5e:	85d2                	mv	a1,s4
    5b60:	8556                	mv	a0,s5
    5b62:	00000097          	auipc	ra,0x0
    5b66:	da0080e7          	jalr	-608(ra) # 5902 <putc>
      state = 0;
    5b6a:	4981                	li	s3,0
    5b6c:	b5d1                	j	5a30 <vprintf+0x60>
        putc(fd, '%');
    5b6e:	85d2                	mv	a1,s4
    5b70:	8556                	mv	a0,s5
    5b72:	00000097          	auipc	ra,0x0
    5b76:	d90080e7          	jalr	-624(ra) # 5902 <putc>
        putc(fd, c);
    5b7a:	85ca                	mv	a1,s2
    5b7c:	8556                	mv	a0,s5
    5b7e:	00000097          	auipc	ra,0x0
    5b82:	d84080e7          	jalr	-636(ra) # 5902 <putc>
      state = 0;
    5b86:	4981                	li	s3,0
    5b88:	b565                	j	5a30 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b8a:	8b4a                	mv	s6,s2
      state = 0;
    5b8c:	4981                	li	s3,0
    5b8e:	b54d                	j	5a30 <vprintf+0x60>
    }
  }
}
    5b90:	70e6                	ld	ra,120(sp)
    5b92:	7446                	ld	s0,112(sp)
    5b94:	74a6                	ld	s1,104(sp)
    5b96:	7906                	ld	s2,96(sp)
    5b98:	69e6                	ld	s3,88(sp)
    5b9a:	6a46                	ld	s4,80(sp)
    5b9c:	6aa6                	ld	s5,72(sp)
    5b9e:	6b06                	ld	s6,64(sp)
    5ba0:	7be2                	ld	s7,56(sp)
    5ba2:	7c42                	ld	s8,48(sp)
    5ba4:	7ca2                	ld	s9,40(sp)
    5ba6:	7d02                	ld	s10,32(sp)
    5ba8:	6de2                	ld	s11,24(sp)
    5baa:	6109                	addi	sp,sp,128
    5bac:	8082                	ret

0000000000005bae <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5bae:	715d                	addi	sp,sp,-80
    5bb0:	ec06                	sd	ra,24(sp)
    5bb2:	e822                	sd	s0,16(sp)
    5bb4:	1000                	addi	s0,sp,32
    5bb6:	e010                	sd	a2,0(s0)
    5bb8:	e414                	sd	a3,8(s0)
    5bba:	e818                	sd	a4,16(s0)
    5bbc:	ec1c                	sd	a5,24(s0)
    5bbe:	03043023          	sd	a6,32(s0)
    5bc2:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5bc6:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5bca:	8622                	mv	a2,s0
    5bcc:	00000097          	auipc	ra,0x0
    5bd0:	e04080e7          	jalr	-508(ra) # 59d0 <vprintf>
}
    5bd4:	60e2                	ld	ra,24(sp)
    5bd6:	6442                	ld	s0,16(sp)
    5bd8:	6161                	addi	sp,sp,80
    5bda:	8082                	ret

0000000000005bdc <printf>:

void
printf(const char *fmt, ...)
{
    5bdc:	711d                	addi	sp,sp,-96
    5bde:	ec06                	sd	ra,24(sp)
    5be0:	e822                	sd	s0,16(sp)
    5be2:	1000                	addi	s0,sp,32
    5be4:	e40c                	sd	a1,8(s0)
    5be6:	e810                	sd	a2,16(s0)
    5be8:	ec14                	sd	a3,24(s0)
    5bea:	f018                	sd	a4,32(s0)
    5bec:	f41c                	sd	a5,40(s0)
    5bee:	03043823          	sd	a6,48(s0)
    5bf2:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5bf6:	00840613          	addi	a2,s0,8
    5bfa:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5bfe:	85aa                	mv	a1,a0
    5c00:	4505                	li	a0,1
    5c02:	00000097          	auipc	ra,0x0
    5c06:	dce080e7          	jalr	-562(ra) # 59d0 <vprintf>
}
    5c0a:	60e2                	ld	ra,24(sp)
    5c0c:	6442                	ld	s0,16(sp)
    5c0e:	6125                	addi	sp,sp,96
    5c10:	8082                	ret

0000000000005c12 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5c12:	1141                	addi	sp,sp,-16
    5c14:	e422                	sd	s0,8(sp)
    5c16:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c18:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c1c:	00003797          	auipc	a5,0x3
    5c20:	9bc7b783          	ld	a5,-1604(a5) # 85d8 <freep>
    5c24:	a02d                	j	5c4e <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c26:	4618                	lw	a4,8(a2)
    5c28:	9f2d                	addw	a4,a4,a1
    5c2a:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c2e:	6398                	ld	a4,0(a5)
    5c30:	6310                	ld	a2,0(a4)
    5c32:	a83d                	j	5c70 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c34:	ff852703          	lw	a4,-8(a0)
    5c38:	9f31                	addw	a4,a4,a2
    5c3a:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5c3c:	ff053683          	ld	a3,-16(a0)
    5c40:	a091                	j	5c84 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c42:	6398                	ld	a4,0(a5)
    5c44:	00e7e463          	bltu	a5,a4,5c4c <free+0x3a>
    5c48:	00e6ea63          	bltu	a3,a4,5c5c <free+0x4a>
{
    5c4c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c4e:	fed7fae3          	bgeu	a5,a3,5c42 <free+0x30>
    5c52:	6398                	ld	a4,0(a5)
    5c54:	00e6e463          	bltu	a3,a4,5c5c <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c58:	fee7eae3          	bltu	a5,a4,5c4c <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5c5c:	ff852583          	lw	a1,-8(a0)
    5c60:	6390                	ld	a2,0(a5)
    5c62:	02059813          	slli	a6,a1,0x20
    5c66:	01c85713          	srli	a4,a6,0x1c
    5c6a:	9736                	add	a4,a4,a3
    5c6c:	fae60de3          	beq	a2,a4,5c26 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5c70:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c74:	4790                	lw	a2,8(a5)
    5c76:	02061593          	slli	a1,a2,0x20
    5c7a:	01c5d713          	srli	a4,a1,0x1c
    5c7e:	973e                	add	a4,a4,a5
    5c80:	fae68ae3          	beq	a3,a4,5c34 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5c84:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5c86:	00003717          	auipc	a4,0x3
    5c8a:	94f73923          	sd	a5,-1710(a4) # 85d8 <freep>
}
    5c8e:	6422                	ld	s0,8(sp)
    5c90:	0141                	addi	sp,sp,16
    5c92:	8082                	ret

0000000000005c94 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5c94:	7139                	addi	sp,sp,-64
    5c96:	fc06                	sd	ra,56(sp)
    5c98:	f822                	sd	s0,48(sp)
    5c9a:	f426                	sd	s1,40(sp)
    5c9c:	f04a                	sd	s2,32(sp)
    5c9e:	ec4e                	sd	s3,24(sp)
    5ca0:	e852                	sd	s4,16(sp)
    5ca2:	e456                	sd	s5,8(sp)
    5ca4:	e05a                	sd	s6,0(sp)
    5ca6:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5ca8:	02051493          	slli	s1,a0,0x20
    5cac:	9081                	srli	s1,s1,0x20
    5cae:	04bd                	addi	s1,s1,15
    5cb0:	8091                	srli	s1,s1,0x4
    5cb2:	0014899b          	addiw	s3,s1,1
    5cb6:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5cb8:	00003517          	auipc	a0,0x3
    5cbc:	92053503          	ld	a0,-1760(a0) # 85d8 <freep>
    5cc0:	c515                	beqz	a0,5cec <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cc2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cc4:	4798                	lw	a4,8(a5)
    5cc6:	02977f63          	bgeu	a4,s1,5d04 <malloc+0x70>
    5cca:	8a4e                	mv	s4,s3
    5ccc:	0009871b          	sext.w	a4,s3
    5cd0:	6685                	lui	a3,0x1
    5cd2:	00d77363          	bgeu	a4,a3,5cd8 <malloc+0x44>
    5cd6:	6a05                	lui	s4,0x1
    5cd8:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cdc:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5ce0:	00003917          	auipc	s2,0x3
    5ce4:	8f890913          	addi	s2,s2,-1800 # 85d8 <freep>
  if(p == (char*)-1)
    5ce8:	5afd                	li	s5,-1
    5cea:	a895                	j	5d5e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5cec:	00009797          	auipc	a5,0x9
    5cf0:	10c78793          	addi	a5,a5,268 # edf8 <base>
    5cf4:	00003717          	auipc	a4,0x3
    5cf8:	8ef73223          	sd	a5,-1820(a4) # 85d8 <freep>
    5cfc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5cfe:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d02:	b7e1                	j	5cca <malloc+0x36>
      if(p->s.size == nunits)
    5d04:	02e48c63          	beq	s1,a4,5d3c <malloc+0xa8>
        p->s.size -= nunits;
    5d08:	4137073b          	subw	a4,a4,s3
    5d0c:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d0e:	02071693          	slli	a3,a4,0x20
    5d12:	01c6d713          	srli	a4,a3,0x1c
    5d16:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d18:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d1c:	00003717          	auipc	a4,0x3
    5d20:	8aa73e23          	sd	a0,-1860(a4) # 85d8 <freep>
      return (void*)(p + 1);
    ...
    5d40:	bff1                	j	5d1c <malloc+0x88>
  hp->s.size = nu;
    5d42:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d46:	0541                	addi	a0,a0,16
    5d48:	00000097          	auipc	ra,0x0
    5d4c:	eca080e7          	jalr	-310(ra) # 5c12 <free>
  return freep;
    5d50:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d54:	d971                	beqz	a0,5d28 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d56:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d58:	4798                	lw	a4,8(a5)
    5d5a:	fa9775e3          	bgeu	a4,s1,5d04 <malloc+0x70>
    if(p == freep)
    5d5e:	00093703          	ld	a4,0(s2)
    5d62:	853e                	mv	a0,a5
    5d64:	fef719e3          	bne	a4,a5,5d56 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5d68:	8552                	mv	a0,s4
    5d6a:	00000097          	auipc	ra,0x0
    5d6e:	b60080e7          	jalr	-1184(ra) # 58ca <sbrk>
  if(p == (char*)-1)
    5d72:	fd5518e3          	bne	a0,s5,5d42 <malloc+0xae>
        return 0;
    5d76:	4501                	li	a0,0
    5d78:	bf45                	j	5d28 <malloc+0x94>
