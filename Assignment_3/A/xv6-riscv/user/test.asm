...
int main(int argc, char *argv[]){
  ...
  14:	84858593          	addi	a1,a1,-1976 # 858 <malloc+0x100>
  18:	f5040513          	addi	a0,s0,-176
  1c:	00000097          	auipc	ra,0x0
  20:	2ca080e7          	jalr	714(ra) # 2e6 <memcpy>
  24:	06a00613          	li	a2,106
  28:	4581                	li	a1,0
  2a:	f7240513          	addi	a0,s0,-142
  2e:	00000097          	auipc	ra,0x0
  32:	0de080e7          	jalr	222(ra) # 10c <memset>
  36:	44b1                	li	s1,12
  ...
  3c:	2c6080e7          	jalr	710(ra) # 2fe <fork>
        
         if(rc==0){
  40:	c131                	beqz	a0,84 <main+0x84>
    for(int f=0;f<12;f++){
  42:	34fd                	addiw	s1,s1,-1
  44:	f8f5                	bnez	s1,38 <main+0x38>
  46:	44b1                	li	s1,12
        wait(0);
  ...
  4c:	7f890913          	addi	s2,s2,2040 # 840 <malloc+0xe8>
        wait(0);
  50:	4501                	li	a0,0
  52:	00000097          	auipc	ra,0x0
  56:	2bc080e7          	jalr	700(ra) # 30e <wait>
                 btget(tag=a,buf);
  5a:	ec040593          	addi	a1,s0,-320
  5e:	4501                	li	a0,0
  60:	00000097          	auipc	ra,0x0
  64:	356080e7          	jalr	854(ra) # 3b6 <btget>
                 printf("btget output: %s \n",buf);
  68:	ec040593          	addi	a1,s0,-320
  6c:	854a                	mv	a0,s2
  6e:	00000097          	auipc	ra,0x0
  72:	632080e7          	jalr	1586(ra) # 6a0 <printf>
    for(int i=0;i<12;i++){
  76:	34fd                	addiw	s1,s1,-1
  78:	fce1                	bnez	s1,50 <main+0x50>
  ...
  80:	28a080e7          	jalr	650(ra) # 306 <exit>
                 btput(tag=a,s);
  84:	f5040593          	addi	a1,s0,-176
  88:	00000097          	auipc	ra,0x0
  8c:	31e080e7          	jalr	798(ra) # 3a6 <btput>
              exit(0);
  90:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40e:	4d650513          	addi	a0,a0,1238 # 8e0 <digits>
 412:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ce:	3bec8c93          	addi	s9,s9,958 # 888 <malloc+0x130>
 ...
 4dc:	408b8b93          	addi	s7,s7,1032 # 8e0 <digits>
 ...
 602:	28298993          	addi	s3,s3,642 # 880 <malloc+0x128>
        while(*s != 0){
 606:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6e4:	2187b783          	ld	a5,536(a5) # 8f8 <freep>
 ...
 70c:	00e6ea63          	bltu	a3,a4,720 <free+0x4a>
{
 ...
 74e:	1af73723          	sd	a5,430(a4) # 8f8 <freep>
}
 752:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 780:	17c53503          	ld	a0,380(a0) # 8f8 <freep>
 ...
 7a8:	15490913          	addi	s2,s2,340 # 8f8 <freep>
  if(p == (char*)-1)
 7ac:	5afd                	li	s5,-1
 7ae:	a895                	j	822 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7b0:	00000797          	auipc	a5,0x0
 7b4:	15078793          	addi	a5,a5,336 # 900 <base>
 7b8:	00000717          	auipc	a4,0x0
 7bc:	14f73023          	sd	a5,320(a4) # 8f8 <freep>
 7c0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e4:	10a73c23          	sd	a0,280(a4) # 8f8 <freep>
      return (void*)(p + 1);
 ...
 832:	b60080e7          	jalr	-1184(ra) # 38e <sbrk>
  if(p == (char*)-1)
