...
putc(int fd, char c)
{
 ...
 36c:	f4e080e7          	jalr	-178(ra) # 2b6 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39e:	49650513          	addi	a0,a0,1174 # 830 <digits>
 3a2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 45e:	37ec8c93          	addi	s9,s9,894 # 7d8 <malloc+0xf0>
 ...
 46c:	3c8b8b93          	addi	s7,s7,968 # 830 <digits>
 ...
 592:	24298993          	addi	s3,s3,578 # 7d0 <malloc+0xe8>
        while(*s != 0){
 596:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 674:	1d87b783          	ld	a5,472(a5) # 848 <freep>
 ...
 69c:	00e6ea63          	bltu	a3,a4,6b0 <free+0x4a>
{
 ...
 6de:	16f73723          	sd	a5,366(a4) # 848 <freep>
}
 6e2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 710:	13c53503          	ld	a0,316(a0) # 848 <freep>
 ...
 738:	11490913          	addi	s2,s2,276 # 848 <freep>
  if(p == (char*)-1)
 73c:	5afd                	li	s5,-1
 73e:	a895                	j	7b2 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 740:	00000797          	auipc	a5,0x0
 744:	11078793          	addi	a5,a5,272 # 850 <base>
 748:	00000717          	auipc	a4,0x0
 74c:	10f73023          	sd	a5,256(a4) # 848 <freep>
 750:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 774:	0ca73c23          	sd	a0,216(a4) # 848 <freep>
      return (void*)(p + 1);
 ...
 7c2:	b60080e7          	jalr	-1184(ra) # 31e <sbrk>
  if(p == (char*)-1)
